...
var layoutValidate = {
    Layout: function (layout_name) {
        ...
        if (layout_name === "RPT_IAU_OPERATION") {
            ...
            datePicker.TimeMonthYear("rang_date_id_iau");
            //fnGetProcessStepUserHousekeeping();
            fn_tab_change_iau( "bi_tab" );
            iau_fn_apply_data_to_tb_bi_user_update_status([]);
            rpt_iau_fn_apply_data_to_table_user_deletion([]);
            rpt_iau_fn_apply_data_to_table_bi_user_inactive([],"rpt_bi_inactive_listing");
            rpt_iau_fn_apply_data_to_table_bi_user_close([]);
        ...
        if (layout_name === "RPT_IAU_REVIEW_APPROVE") {
            datePicker.TimeMonthYear("iau_report_date_approve_scr");
            rpt_iau_fn_apply_data_to_table_bi_user_inactive([],"rpt_bi_inactive_review_listing_review");
            rpt_iau_apply_data_table_db_iau( [] );
        ...
        if (layout_name == "OS_PASSWORD_GENERATION") {
            ...
            selectionStyle.Multiple("os_pwd_user_role_select", undefined);
        }
        //khim insert patch
