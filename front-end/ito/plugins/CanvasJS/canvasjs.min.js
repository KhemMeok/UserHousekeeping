...
(function() {
    ...
    function hb(h) {
        if (!ib) {
            var m = !1,
                w = !1;
            "undefined" === typeof pa.Chart.creditHref ? (h.creditHref = X("iuuqr;..b`ow`rkr/bnl."),
                h.creditText = X("B`ow`rKR/bnl")) : (m = h.updateOption("creditText"), w = h.updateOption("creditHref"));
    ...
    var fb = function() {
                ...
                return M = N.replace(h, function(l) {
                    switch (l) {
                        ...
                        case "TT":
                            return 12 > d ? "AM" : "PM";
                        case "K":
                            return R ? "UTC" : (String(E).match(y) || [""]).pop().replace(D, "");
                        case "z":
            ...
            for (var L = 0; E && L < E.length; L++)
                if (m = E[L], "." === m && 0 > N) N = L;
                    ...
                    0 > N ? (M.push(m), "#" === m || "0" === m ? H++ : "," === m &&
                        R++) : (T.push(m), "#" !== m && "0" !== m || Q++)
                } J && (m = Math.floor(h), E = -Math.floor(Math.log(h) / Math.LN10 + 1), V = 0 === h ? 0 : 0 === m ? -(H + E) : String(m).length - H, D /= Math.pow(10, V));
            0 > N && (N = L);
            D = (h * D).toFixed(Q);
            m = D.split(".");
            D = (m[0] + "").split("");
            ...
            for (J = E = L = Q = N = 0; 0 < M.length;)
                if (m = M.pop(), "#" === m || "0" === m)
                    if (N++, N === H) {
                        ...
                        for (; 0 < W.length;) w = W.pop() + w, J++, 0 === J % E && (L === R && 0 < W.length) && (w = y + w)
                    } else 0 < D.length ?
                        (w = D.pop() + w, Q++, J++) : "0" === m && (w = "0" + w, Q++, J++), 0 === J % E && (L === R && 0 < D.length) && (w = y + w);
            else "E" !== m[0] && "e" !== m[0] || "0" !== m[m.length - 1] || !/[eE][+-]*[0]+/.test(m) ? "," === m ? (L++, E = J, J = 0, 0 < D.length && (w = y + w)) : w = 1 < m.length && ('"' === m[0] && '"' === m[m.length - 1] || "'" === m[0] && "'" === m[m.length - 1]) ? m.slice(1, m.length - 1) + w : m + w : (m = 0 > V ? m.replace("+", "").replace("-", "") : m.replace("-", ""), w += m.replace(/[0]+/, function(a) {
                return Y(V, a.length)
            }));
            y = "";
        ...
        Ma = 1,
        ga = Za ? Qa / Ma : 1,
        ca = function(h, m, w, s, v, y, D, E, N, M, T, Q, J) {
            ...
            h.globalAlpha = 1;
            0 < D && (J = 0 === D % 2 ? 0 : 0.5, h.beginPath(), h.lineWidth = D, h.strokeStyle = E, h.moveTo(m, w), h.rect(m - J, w - J, s - m + 2 * J, v - w + 2 * J), h.stroke());
            h.restore();
    ...
    V.prototype.updateOption = function(h) {
        ...
        var m = pa[this._defaultsKey],
            ...
            H = this._index;
        this.theme && s(this.parent) && s(E) && s(H) ? v = s(this.predefinedThemes[this.theme]) ? this.predefinedThemes.light1 : this.predefinedThemes[this.theme] : this.parent && (this.parent.themeOptions && this.parent.themeOptions[E]) && (null === H ? v = this.parent.themeOptions[E] : 0 < this.parent.themeOptions[E].length && (v = Math.min(this.parent.themeOptions[E].length - 1, H), v = this.parent.themeOptions[E][v]));
        this.themeOptions = v;
    ...
    y = Oa.Chart = function() {
            ...
            if (this.options.data) {
                for (var c = 0; c < this.options.data.length; c++)
                    if (a++, !this.options.data[c].type || 0 <= m._supportedChartTypes.indexOf(this.options.data[c].type)) {
                        ...
                        "error" === b.type && (b.linkedDataSeriesIndex = s(this.options.data[c].linkedDataSeriesIndex) ? c - 1 : this.options.data[c].linkedDataSeriesIndex, 0 > b.linkedDataSeriesIndex || b.linkedDataSeriesIndex >= this.options.data.length || "number" !== typeof b.linkedDataSeriesIndex || "error" ===
                            this.options.data[b.linkedDataSeriesIndex].type) && (b.linkedDataSeriesIndex = null);
                        ...
                        null === b.color ? 1 < this.options.data.length ? (b._colorSet = [this.selectedColorSet[b.index % this.selectedColorSet.length]], b.color = this.selectedColorSet[b.index % this.selectedColorSet.length]) : b._colorSet = "line" === b.type || "stepLine" === b.type || "spline" === b.type || "area" === b.type || "stepArea" === b.type || "splineArea" === b.type || "stackedArea" === b.type || "stackedArea100" === b.type || "rangeArea" ===
                            b.type || "rangeSplineArea" === b.type || "candlestick" === b.type || "ohlc" === b.type || "waterfall" === b.type || "boxAndWhisker" === b.type ? [this.selectedColorSet[0]] : this.selectedColorSet : b._colorSet = [b.color];
        ...
        m._supportedChartTypes =
            Ba("line stepLine spline column area stepArea splineArea bar bubble scatter stackedColumn stackedColumn100 stackedBar stackedBar100 stackedArea stackedArea100 candlestick ohlc boxAndWhisker rangeColumn error rangeBar rangeArea rangeSplineArea pie doughnut funnel pyramid waterfall".split(" "));
        m.prototype.setLayout = function() {
                    ...
                    if (!this.data[d].axisYType ||
                        ...
                        if (this.options.axisY && 0 < this.options.axisY.length) {
                            if (!this.axisY.length)
                                for (var c = 0; c < this.options.axisY.length; c++) "normal" === this.plotInfo.axisPlacement ? this._axes.push(this.axisY[c] = new D(this, "axisY", this.options.axisY[c], c, "axisY", "left")) : "xySwapped" === this.plotInfo.axisPlacement && this._axes.push(this.axisY[c] = new D(this, "axisY", this.options.axisY[c], c, "axisY", "bottom"));
                    ...
                    if ("secondary" === this.data[d].axisYType)
                        if (this.options.axisY2 && 0 < this.options.axisY2.length) {
                            if (!this.axisY2.length)
                                for (c = 0; c < this.options.axisY2.length; c++) "normal" === this.plotInfo.axisPlacement ? this._axes.push(this.axisY2[c] = new D(this, "axisY2", this.options.axisY2[c], c, "axisY", "right")) : "xySwapped" === this.plotInfo.axisPlacement && this._axes.push(this.axisY2[c] = new D(this, "axisY2", this.options.axisY2[c], c, "axisY", "top"));
                    ...
                    if (!this.data[d].axisXType || "primary" === this.data[d].axisXType)
                        if (this.options.axisX && 0 < this.options.axisX.length) {
                            if (!this.axisX.length)
                                for (c = 0; c < this.options.axisX.length; c++) "normal" === this.plotInfo.axisPlacement ? this._axes.push(this.axisX[c] = new D(this, "axisX", this.options.axisX[c], c, "axisX", "bottom")) : "xySwapped" === this.plotInfo.axisPlacement && this._axes.push(this.axisX[c] = new D(this, "axisX", this.options.axisX[c], c, "axisX", "left"));
                            this.data[d].axisX =
                    ...
                    if ("secondary" === this.data[d].axisXType)
                        if (this.options.axisX2 && 0 < this.options.axisX2.length) {
                            if (!this.axisX2.length)
                                for (c = 0; c < this.options.axisX2.length; c++) "normal" === this.plotInfo.axisPlacement ? this._axes.push(this.axisX2[c] = new D(this, "axisX2", this.options.axisX2[c], c, "axisX", "top")) : "xySwapped" === this.plotInfo.axisPlacement && this._axes.push(this.axisX2[c] = new D(this, "axisX2", this.options.axisX2[c],
                                    c, "axisX", "right"));
            ...
            if (this.axisX)
                for (c = 0; c < this.axisX.length; c++) "undefined" === typeof this.axisX[c].options.gridThickness &&
            ...
            if (0 < this._axes.length &&
                ...
                0) + "px solid " + this.toolbar.borderColor) : (ta(this._zoomButton, this._resetButton), this._toolBar.style.border = this.toolbar.borderThickness + "px solid transparent", this.options.zoomEnabled && (this.zoomEnabled = !0, this.panEnabled = !1));
            //eb(this);
            this._processData();
            ...
            if (this.options.subtitles)
                for (d = 0; d < this.options.subtitles.length; d++) c = new Ha(this, this.options.subtitles[d],
            ...
            for (d = 0; d < this._axes.length; d++)
                if (this._axes[d].scaleBreaks && this._axes[d].scaleBreaks._appliedBreaks.length) {
                    v ?
                        (this._breaksCanvas = sa(this.width, this.height, !0), this._breaksCanvasCtx = this._breaksCanvas.getContext("2d")) : (this._breaksCanvas = this.canvas, this._breaksCanvasCtx = this.ctx);
                    break
            ...
            function() {
                ...
                for (d = 0; d < this.plotInfo.plotTypes.length; d++)
                    for (var f = this.plotInfo.plotTypes[d], l = 0; l < f.plotUnits.length; l++) {
                        ...
                        "line" === u.type ? A = this.renderLine(u) : "stepLine" === u.type ? A = this.renderStepLine(u) :
                            ...
                            A = this.renderRangeBar(u) : "rangeArea" === u.type ? A = this.renderRangeArea(u) : "rangeSplineArea" === u.type ? A = this.renderRangeSplineArea(u) : "waterfall" === u.type ? A = this.renderWaterfall(u) : "boxAndWhisker" === u.type && (A = this.renderBoxAndWhisker(u));
                ...
                if (0 < c.length) n.disableToolTip = !0, n._animator.animate(200, n.animationDuration, function(a) {
                    ...
                    for (var e =
                            0; e < c.length; e++) A = c[e], 1 > a && "undefined" !== typeof A.startTimePercent ? a >= A.startTimePercent && A.animationCallback(A.easingFunction(a - A.startTimePercent, 0, 1, 1 - A.startTimePercent), A) : A.animationCallback(A.easingFunction(a, 0, 1, 1), A);
        ...
        m.prototype.categoriseDataSeries = function() {
            for (var a = "", d = 0; d < this.data.length; d++)
                if (a = this.data[d], a.dataPoints && (0 !== a.dataPoints.length && a.visible) && 0 <= m._supportedChartTypes.indexOf(a.type)) {
                    for (var c =
                            null, b = !1, e = null, f = !1, l = 0; l < this.plotInfo.plotTypes.length; l++)
        ...
        m.prototype._processData = function() {
            ...
            for (var a = 0; a < this.plotInfo.plotTypes.length; a++)
                for (var d = this.plotInfo.plotTypes[a], c = 0; c < d.plotUnits.length; c++) {
                    var b = d.plotUnits[c];
                    "line" === b.type || "stepLine" === b.type || "spline" === b.type || "column" === b.type || "area" === b.type || "stepArea" === b.type || "splineArea" === b.type || "bar" === b.type || "bubble" === b.type || "scatter" === b.type ? this._processMultiseriesPlotUnit(b) : "stackedColumn" === b.type || "stackedBar" === b.type ||
                ...
                if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))
                    for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, l = 0; l < a.dataSeriesIndexes.length; l++) {
                        var u = this.data[a.dataSeriesIndexes[l]],
                            ...
                            n = !1,
                            p;
                        if ("normal" === u.axisPlacement || "xySwapped" === u.axisPlacement) var q = a.axisX.sessionVariables.newViewportMinimum ? a.axisX.sessionVariables.newViewportMinimum : this.options.axisX && this.options.axisX.viewportMinimum ? this.options.axisX.viewportMinimum : this.options.axisX && this.options.axisX.minimum ?
                        ...
                        for (A = 0; A < u.dataPoints.length; A++) {
                            ...
                            if (0 < A) {
                                ...
                                null !== e && null !== u.dataPoints[A - 1].y && (a.axisY.logarithmic ? (r = e / u.dataPoints[A - 1].y, 1 > r && (r =
                            ...
                            if (b < q && !k) null !== e && (p = b);
                                ...
                                null === e ? c.viewPortMin === b && p < b && (c.viewPortMin = p) : (e < d.viewPortMin && "number" === typeof e && (d.viewPortMin = e), e > d.viewPortMax && "number" === typeof e && (d.viewPortMax =
                                    e))
                            }
                        }
            ...
            if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
                for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, l = [], u = [], A = Infinity, k = -Infinity, n = 0; n < a.dataSeriesIndexes.length; n++) {
                    var p = this.data[a.dataSeriesIndexes[n]],
                        ...
                        r = !1,
                        h;
                    if ("normal" === p.axisPlacement || "xySwapped" === p.axisPlacement) var m = a.axisX.sessionVariables.newViewportMinimum ? a.axisX.sessionVariables.newViewportMinimum :
                    ...
                    for (q = 0; q < p.dataPoints.length; q++) {
                        ...
                        if (b < m && !g) null !== p.dataPoints[q].y && (h = b);
                            ...
                            b < c.viewPortMin && (c.viewPortMin = b);
                            b > c.viewPortMax && (c.viewPortMax = b);
                            null === p.dataPoints[q].y ? c.viewPortMin === b && h < b && (c.viewPortMin = h) :
                ...
                if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
                    for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, l = !1, u = !1, A = [], k = 0; k < a.dataSeriesIndexes.length; k++) {
                        var n = this.data[a.dataSeriesIndexes[k]],
                            ...
                            g = !1,
                            r;
                        if ("normal" === n.axisPlacement || "xySwapped" === n.axisPlacement) var h = a.axisX.sessionVariables.newViewportMinimum ? a.axisX.sessionVariables.newViewportMinimum : this.options.axisX && this.options.axisX.viewportMinimum ? this.options.axisX.viewportMinimum : this.options.axisX && this.options.axisX.minimum ?
                        ...
                        for (p = 0; p < n.dataPoints.length; p++) {
                            ...
                            if (0 < p) {
                                ...
                                s(e) || null === n.dataPoints[p - 1].y || (a.axisY.logarithmic ? 0 < e && (t = e / n.dataPoints[p - 1].y, 1 > t && (t = 1 / t), d.minDiff > t && 1 !== t && (d.minDiff = t)) : (t = e - n.dataPoints[p -
                            ...
                            if (b < h && !q) null !== e && (r = b);
                                ...
                                b < c.viewPortMin && (c.viewPortMin = b);
                                b > c.viewPortMax && (c.viewPortMax = b);
                                null === e ? c.viewPortMin === b && r < b && (c.viewPortMin = r) : (a.yTotals[b] = (a.yTotals[b] ? a.yTotals[b] : 0) + e, a.yAbsTotals[b] = (a.yAbsTotals[b] ? a.yAbsTotals[b] : 0) + Math.abs(e), 0 <= e ? l = !0 : 0 > e && (u = !0), A[b] = A[b] ? A[b] + Math.abs(e) :
                                    Math.abs(e))
                            }
                        }
                    ...
                    a.axisY.logarithmic ? (d.max = s(d.viewPortMax) ? 99 * Math.pow(a.axisY.logarithmBase, -0.05) : Math.max(d.viewPortMax, 99 * Math.pow(a.axisY.logarithmBase, -0.05)), d.min = s(d.viewPortMin) ? 1 : Math.min(d.viewPortMin, 1)) : l && !u ? (d.max = s(d.viewPortMax) ? 99 : Math.max(d.viewPortMax, 99), d.min = s(d.viewPortMin) ? 1 : Math.min(d.viewPortMin, 1)) : l && u ? (d.max = s(d.viewPortMax) ? 99 : Math.max(d.viewPortMax, 99), d.min = s(d.viewPortMin) ? -99 : Math.min(d.viewPortMin, -99)) : !l && u &&
                        (d.max = s(d.viewPortMax) ? -1 : Math.max(d.viewPortMax, -1), d.min = s(d.viewPortMin) ? -99 : Math.min(d.viewPortMin, -99));
                    d.viewPortMin = d.min;
                    d.viewPortMax = d.max;
                    a.dataPointYSums = A
                }
        ...
        m.prototype._processMultiYPlotUnit = function(a) {
            if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))
                for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f, l, u = !1, A = 0; A < a.dataSeriesIndexes.length; A++) {
                    var k = this.data[a.dataSeriesIndexes[A]],
                        n = 0,
                        p = !1,
                        q = !1,
                        g, r, h;
                    if ("normal" === k.axisPlacement || "xySwapped" === k.axisPlacement) var m = a.axisX.sessionVariables.newViewportMinimum ?
            ...
            if ("waterfall" === a.type && a.dataSeriesIndexes &&
                ...
                for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, l = 0; l < a.dataSeriesIndexes.length; l++) {
                    ...
                    if ("normal" === u.axisPlacement || "xySwapped" === u.axisPlacement) var q = a.axisX.sessionVariables.newViewportMinimum ? a.axisX.sessionVariables.newViewportMinimum : this.options.axisX && this.options.axisX.viewportMinimum ? this.options.axisX.viewportMinimum : this.options.axisX && this.options.axisX.minimum ? this.options.axisX.minimum :
                        ...
                        g = a.axisX.sessionVariables.newViewportMaximum ? a.axisX.sessionVariables.newViewportMaximum : this.options.axisX && this.options.axisX.viewportMaximum ? this.options.axisX.viewportMaximum : this.options.axisX && this.options.axisX.maximum ? this.options.axisX.maximum : Infinity;
                    if (u.dataPoints[A].x && u.dataPoints[A].x.getTime || "dateTime" === u.xValueType) f = !0;
                    for (A = 0; A < u.dataPoints.length; A++) "undefined" !== typeof u.dataPoints[A].isCumulativeSum && !0 === u.dataPoints[A].isCumulativeSum ? (u.dataPointEOs[A].cumulativeSumYStartValue =
                        ...
                        0 === A ? 0 : u.dataPointEOs[A - 1].cumulativeSum, u.dataPointEOs[A].cumulativeSum = 0 === A ? e : u.dataPointEOs[A - 1].cumulativeSum + e, b += e);
                    for (A = 0; A < u.dataPoints.length; A++)
                        ...
                        for (var d = a.axisY.dataInfo, f = a.axisX.dataInfo, g, k = f.min, l = f.max, n = d.min, p = d.max, f = f._dataRanges, d = d._dataRanges, q, u = 0, A = 0; A < a.dataSeriesIndexes.length; A++) {
                            ...
                            if (!(4 > h.dataPoints.length))
                                for (u = 0; u < h.dataPoints.length; u++)
                                    if (b && (q = (l + 1 - k) * Math.max(parseFloat(a.axisX.scaleBreaks.collapsibleThreshold) ||
                                        ...
                                        else s(g) || (q = Math.floor((g - n) / m), g < d[q].min && (d[q].min =
                ...
                if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length) && a.axisX.scaleBreaks && a.axisX.scaleBreaks.autoCalculate && 1 <= a.axisX.scaleBreaks.maxNumberOfAutoBreaks)
                    for (var b = a.axisX.dataInfo, c = b.min, d = b.max, f = b._dataRanges, g, k = 0, l = 0; l < a.dataSeriesIndexes.length; l++) {
                        ...
                        if (!(4 > n.dataPoints.length))
                            for (k = 0; k < n.dataPoints.length; k++) g = (d + 1 - c) * Math.max(parseFloat(a.axisX.scaleBreaks.collapsibleThreshold) || 10, 10) / 100, b = n.dataPoints[k].x.getTime ?
                            ...
                            for (u = 0; u < this._axes[l].scaleBreaks.customBreaks.length; u++)
                                for (b = 0; b < f.length; b++)
                                    if (this._axes[l].scaleBreaks.customBreaks[u].startValue <= f[b].start && f[b].start <= this._axes[l].scaleBreaks.customBreaks[u].endValue || this._axes[l].scaleBreaks.customBreaks[u].startValue <= f[b].start && f[b].start <= this._axes[l].scaleBreaks.customBreaks[u].endValue || f[b].start <= this._axes[l].scaleBreaks.customBreaks[u].startValue &&
                                        this._axes[l].scaleBreaks.customBreaks[u].startValue <= f[b].end || f[b].start <= this._axes[l].scaleBreaks.customBreaks[u].endValue && this._axes[l].scaleBreaks.customBreaks[u].endValue <= f[b].end) f.splice(b, 1), b--;
                        f.sort(function(a, b) {
                            return b.diff - a.diff
                        });
                        for (u = 0; u < Math.min(f.length, this._axes[l].scaleBreaks.maxNumberOfAutoBreaks); u++) b = a(f[u].start, f[u].end, this._axes[l].logarithmic ? this._axes[l].dataInfo.max / this._axes[l].dataInfo.min : this._axes[l].dataInfo.max - this._axes[l].dataInfo.min, this._axes[l].logarithmic),
                            this._axes[l].scaleBreaks.autoBreaks.push(new U(this, "autoBreaks", b, u, ++this._eventManager.lastObjectId, this._axes[l].scaleBreaks)), this._axes[l].scaleBreaks._appliedBreaks.push(this._axes[l].scaleBreaks.autoBreaks[this._axes[l].scaleBreaks.autoBreaks.length - 1]);
        ...
        m.prototype.validateRegion = function(a, d, c, b, e) {
            e = e || !1;
            for (var f = 0 <= this.zoomType.indexOf("x"), l = 0 <= this.zoomType.indexOf("y"), u = !1, A = [], k = [], n = [], p = 0; p < this._axes.length; p++)("axisX" === this._axes[p].type && f || "axisY" === this._axes[p].type &&
                l) && k.push(this._axes[p]);
            for (l = 0; l < k.length; l++) {
                ...
                if (isFinite(p.dataInfo.minDiff))
                    if (r = p.getApparentDifference(q, g, null, !0), !(f || !(this.panEnabled && p.scaleBreaks && p.scaleBreaks._appliedBreaks.length) && (p.logarithmic && r < Math.pow(p.dataInfo.minDiff,
                            3) || !p.logarithmic && r < 3 * Math.abs(p.dataInfo.minDiff)) || q < p.minimum || g > p.maximum)) A.push(p), n.push({
                        val1: q,
                        val2: g
                    }), u = !0;
                    else if (!e) {
        ...
        m.prototype.renderIndexLabels = function(a) {
            ...
            for (a = 0; a < this._indexLabels.length; a++) {
                ...
                var m = ka("indexLabelLineDashType",
                    ...
                    B = null;
                if (0 <= n.dataSeries.type.indexOf("stacked") || "pie" === n.dataSeries.type || "doughnut" === n.dataSeries.type) F = this.getPercentAndTotal(n.dataSeries,
                    n.dataPoint);
                ...
                var C = n.dataPoint.indexLabelFormatter ? n.dataPoint.indexLabelFormatter(B) : n.dataPoint.indexLabel ? this.replaceKeywordsWithValue(n.dataPoint.indexLabel, n.dataPoint, n.dataSeries, null, n.indexKeyword) : n.dataSeries.indexLabelFormatter ? n.dataSeries.indexLabelFormatter(B) : n.dataSeries.indexLabel ? this.replaceKeywordsWithValue(n.dataSeries.indexLabel,
                    n.dataPoint, n.dataSeries, null, n.indexKeyword) : null;
                if (null !== C && "" !== C) {
                    var F = ka("indexLabelPlacement", n.dataPoint, n.dataSeries),
                        B = ka("indexLabelOrientation", n.dataPoint, n.dataSeries),
                        z = ka("indexLabelTextAlign", n.dataPoint, n.dataSeries),
                        w = n.direction,
                    ...
                    if ("normal" === this.plotInfo.axisPlacement) {
                        if (0 <= p.indexOf("line") || 0 <= p.indexOf("area")) F = "auto", u = 4;
                        else if (0 <= p.indexOf("stacked")) "auto" === F && (F = "inside");
                        else if ("bubble" ===
                            p || "scatter" === p) F = "inside";
                        ...
                        B ? 0 : r / 2), q = 0 > w ? Math.max(n.point.x, b) - ("horizontal" === B ? A / 2 : 0) : Math.min(n.point.x, b) - A / 2, q = Math.max(q, e));
                    "vertical" === B && (g += k - r / 2);
                    h.x = q;
                    h.y = g;
                    h.render(!0);
                    x && ("inside" !== F && (0 > p.indexOf("bar") && ("error" !== p || !n.axisSwapped) && n.point.x > c.x1 && n.point.x < c.x2 || !y) && (0 > p.indexOf("column") && ("error" !== p || n.axisSwapped) && n.point.y > c.y1 && n.point.y < c.y2 || !y)) && (d.lineWidth = x, d.strokeStyle = t ? t : "gray", d.setLineDash && d.setLineDash(N(m, x)), d.beginPath(), d.moveTo(n.point.x, n.point.y), 0 <= p.indexOf("bar") || "error" ===
        ...
        m.prototype.renderLine = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                    ...
                    if (0 < n.length) {
                        for (var B = !1, t = 0; t < n.length; t++)
                            if (x = n[t].x.getTime ? n[t].x.getTime() : n[t].x, !(x < a.axisX.dataInfo.viewPortMin || x > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !B)))
                                if ("number" !== typeof n[t].y) 0 < t && !(k.connectNullData || B || m) && (c.stroke(), v && b.stroke()), B = !0;
                                else {
                                    ...
                                    m || B ? (!m && k.connectNullData ? (c.setLineDash && (k.options.nullDataLineDashType || p === k.lineDashType && k.lineDashType !== k.nullDataLineDashType) && (c.stroke(), c.beginPath(), c.moveTo(l.x, l.y), p = k.nullDataLineDashType, c.setLineDash(q)), c.lineTo(x, s), v && b.lineTo(x, s)) : (c.beginPath(), c.moveTo(x, s), v && (b.beginPath(), b.moveTo(x, s))), B = m = !1) : (c.lineTo(x, s), v && b.lineTo(x, s), 0 == t % 500 && (c.stroke(), c.beginPath(), c.moveTo(x, s), v && (b.stroke(), b.beginPath(), b.moveTo(x, s))));
                                    l = {
                                        x: x,
                                        y: s
                                    };
                                    t < n.length -
                                        1 && (h !== (n[t].lineColor || r) || p !== (n[t].lineDashType || k.lineDashType)) && (c.stroke(), c.beginPath(), c.moveTo(x, s), h = n[t].lineColor || r, c.strokeStyle = h, c.setLineDash && (n[t].lineDashType ? (p = n[t].lineDashType, c.setLineDash(N(p, k.lineThickness))) : (p = k.lineDashType, c.setLineDash(g))));
                                    ...
                                    }(n[t].indexLabel || k.indexLabel ||
                                        n[t].indexLabelFormatter || k.indexLabelFormatter) && this._indexLabels.push({
                                        chartType: "line",
                                        dataPoint: n[t],
                                        dataSeries: k,
                                        point: {
                ...
                v && (d.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), c.globalCompositeOperation = "source-atop", a.axisX.maskCanvas && c.drawImage(a.axisX.maskCanvas, 0, 0, this.width, this.height), a.axisY.maskCanvas && c.drawImage(a.axisY.maskCanvas, 0, 0, this.width, this.height), this._breaksCanvasCtx &&
                    this._breaksCanvasCtx.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), c.clearRect(e.x1, e.y1, e.width, e.height), b.beginPath());
                c.restore();
                c.beginPath();
                return {
                    source: d,
        ...
        m.prototype.renderStepLine = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                            ...
                            if (x = n[t].getTime ? n[t].x.getTime() : n[t].x, !(x < a.axisX.dataInfo.viewPortMin || x > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !B)))
                                if ("number" !== typeof n[t].y) 0 < t && !(k.connectNullData || B || m) && (c.stroke(), v && b.stroke()), B = !0;
                                    ...
                                    m || B ? (!m && k.connectNullData ? (c.setLineDash && (k.options.nullDataLineDashType || p === k.lineDashType && k.lineDashType !== k.nullDataLineDashType) && (c.stroke(), c.beginPath(), c.moveTo(l.x, l.y), p = k.nullDataLineDashType, c.setLineDash(q)), c.lineTo(x, C), c.lineTo(x, s), v && (b.lineTo(x, C), b.lineTo(x, s))) : (c.beginPath(), c.moveTo(x, s), v && (b.beginPath(), b.moveTo(x, s))), B = m = !1) : (c.lineTo(x, C), v && b.lineTo(x, C), c.lineTo(x, s), v && b.lineTo(x, s), 0 == t %
                                        500 && (c.stroke(), c.beginPath(), c.moveTo(x, s), v && (b.stroke(), b.beginPath(), b.moveTo(x, s))));
                                    l = {
                                        x: x,
                                        y: s
                                    };
                                    ...
                                    if (0 < n[t].markerSize || 0 < k.markerSize) C = k.getMarkerProperties(t, x, s, c), f.push(C), z = Q(z), v && f.push({
                                        x: x,
                                        y: s,
                                        ctx: b,
                                        type: C.type,
                ...
                v && (d.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), c.globalCompositeOperation = "source-atop", a.axisX.maskCanvas && c.drawImage(a.axisX.maskCanvas,
                    0, 0, this.width, this.height), a.axisY.maskCanvas && c.drawImage(a.axisY.maskCanvas, 0, 0, this.width, this.height), this._breaksCanvasCtx && this._breaksCanvasCtx.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), c.clearRect(e.x1, e.y1, e.width, e.height), b.beginPath());
                c.restore();
                c.beginPath();
                return {
                    source: d,
        ...
        m.prototype.renderSpline = function(a) {
            function d(a) {
                ...
                if (0 < a.length) {
                    ...
                    for (var c = 0; c < a.length - 3; c += 3)
                        if (b.bezierCurveTo(a[c + 1].x, a[c + 1].y, a[c + 2].x, a[c + 2].y, a[c + 3].x, a[c + 3].y), v && e.bezierCurveTo(a[c + 1].x, a[c + 1].y, a[c + 2].x, a[c + 2].y, a[c + 3].x, a[c + 3].y), 0 < c && 0 === c % 3E3 || a[c + 3].newStrokeStyle || a[c + 3].newLineDashArray) b.stroke(), b.beginPath(), b.moveTo(a[c + 3].x, a[c + 3].y), a[c + 3].newStrokeStyle &&
                            (b.strokeStyle = a[c + 3].newStrokeStyle), a[c + 3].newLineDashArray && b.setLineDash(a[c + 3].newLineDashArray), v && (e.stroke(), e.beginPath(), e.moveTo(a[c + 3].x, a[c + 3].y));
                    b.stroke();
                    v && e.stroke()
                }
            }
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                    ...
                    if (0 < n.length)
                        for (x = !1, m =
                            ...
                            if (t = n[m].getTime ? n[m].x.getTime() : n[m].x, !(t < a.axisX.dataInfo.viewPortMin || t > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !x)))
                                if ("number" !== typeof n[m].y) 0 < m && !x && (k.connectNullData ? b.setLineDash && (0 < s.length && (k.options.nullDataLineDashType || !n[m - 1].lineDashType)) && (s[s.length - 1].newLineDashArray = q, p = k.nullDataLineDashType) : (d(s), s = [])), x = !0;
                                else {
                ...
                W.drawMarkers(l);
                v && (c.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), b.globalCompositeOperation = "source-atop", a.axisX.maskCanvas && b.drawImage(a.axisX.maskCanvas, 0, 0, this.width,
                    this.height), a.axisY.maskCanvas && b.drawImage(a.axisY.maskCanvas, 0, 0, this.width, this.height), this._breaksCanvasCtx && this._breaksCanvasCtx.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), b.clearRect(f.x1, f.y1, f.width, f.height), e.beginPath());
                b.restore();
                b.beginPath();
                return {
                    source: c,
        ...
        m.prototype.renderStackedColumn = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                !this.dataPointMaxWidth && (this.dataPointMinWidth &&
                    n < k) && (n = Math.max(this.options.dataPointWidth ? this.dataPointWidth : -Infinity, k));
                g < k && (g = k);
                g > n && (g = n);
                c.save();
                v && this._eventManager.ghostCtx.save();
                        ...
                        for (k = 0; k < t.length; k++)
                            if (b = t[k].x.getTime ? t[k].x.getTime() : t[k].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof t[k].y) {
                                ...
                                var s = n - a.plotType.plotUnits.length * g / 2 + a.index * g << 0,
                                    B = s + g << 0,
                                    C;
                                if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < t[k].y) u[b] = t[k].y + (u[b] ? u[b] : 0), 0 < u[b] && (p = a.axisY.convertValueToPixel(u[b]), C = "undefined" !== typeof f[b] ? f[b] : q, f[b] = p);
                                else if (a.axisY.scaleBreaks &&
                                    0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= t[k].y) A[b] = t[k].y + (A[b] ? A[b] : 0), C = a.axisY.convertValueToPixel(A[b]), p = "undefined" !== typeof l[b] ? l[b] : q, l[b] = C;
                                ...
                                b = Q(b);
                                v && ca(this._eventManager.ghostCtx, s, p, B, C, b, 0, null, !1, !1, !1, !1);
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var r = 0; r < a.dataSeriesIndexes.length; r++) {
                    var h = a.dataSeriesIndexes[r],
                        ...
                        t = m.dataPoints;
                    if (0 < t.length)
                        for (var x = 5 < g && m.bevelEnabled ? !0 : !1,
                                k = 0; k < t.length; k++)
                            if (b = t[k].x.getTime ? t[k].x.getTime() : t[k].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof t[k].y) {
                                n = a.axisX.convertValueToPixel(b);
                                ...
                                if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < t[k].y) {
                                    ...
                                    f[b] = z + (C - p)
                                } else z = "undefined" !== typeof l[b] ? l[b] : 0, C = p + z, p = q + z, a.dataSeriesIndexes.length - 1 === r && 1 >= Math.abs(e.y2 - C) && (C = e.y2), l[b] =
                                    z + (C - p);
                                b = t[k].color ? t[k].color : m._colorSet[k % m._colorSet.length];
                                ca(c, s, p, B, C, b, 0, null, x && 0 <= t[k].y, 0 > t[k].y && x, !1, !1, m.fillOpacity);
                                b = m.dataPointIds[k];
        ...
        m.prototype.renderBar = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var b = null,
                    e = this.plotArea,
                    f = 0,
                    l, u, A, k = a.axisY.convertValueToPixel(a.axisY.logarithmic ?
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var r = 0; r < a.dataSeriesIndexes.length; r++) {
                    ...
                    if (0 < t.length) {
                        ...
                        c.strokeStyle = "#4572A7 ";
                        for (k = 0; k < t.length; k++)
                            if (b = t[k].x.getTime ? t[k].x.getTime() : t[k].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" ===
                                typeof t[k].y) {
                                ...
                                else if (n = a.axisY.convertValueToPixel(t[k].y),
                                    0 <= t[k].y) {
                                    var z = f[b] ? f[b] : 0;
                                    C = q + z;
                                    n += z;
                                ...
                                b = Q(b);
                                v && ca(this._eventManager.ghostCtx, C, s, n, B, b, 0, null, !1, !1, !1, !1);
                                (t[k].indexLabel || m.indexLabel || t[k].indexLabelFormatter || m.indexLabelFormatter) && this._indexLabels.push({
        ...
        m.prototype.renderStackedBar100 = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                var g = a.axisX.dataInfo.minDiff;
                isFinite(g) || (g = 0.3 * Math.abs(a.axisX.range));
                g = this.options.dataPointWidth ? this.dataPointWidth : 0.9 * (e.height * (a.axisX.logarithmic ? Math.log(g) /
                    ...
                    if (0 < t.length) {
                        ...
                        for (k = 0; k < t.length; k++)
                            if (b = t[k].x.getTime ? t[k].x.getTime() : t[k].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof t[k].y) {
                                ...
                                var B =
                                    p - a.plotType.plotUnits.length * g / 2 + a.index * g << 0,
                                    C = B + g << 0;
                                if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < t[k].y) {
                                    u[b] = s + (u[b] ? u[b] : 0);
                                    if (0 >= u[b]) continue;
                                ...
                                } else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= t[k].y) A[b] = s + (A[b] ? A[b] : 0), n = l[b] ? l[b] : q, l[b] = s = a.axisY.convertValueToPixel(A[b]);
                                else if (n = a.axisY.convertValueToPixel(s), 0 <= t[k].y) {
                                    var z = f[b] ? f[b] : 0;
                                    s = q + z;
                                    n += z;
                                    a.dataSeriesIndexes.length -
                                        1 === r && 1 >= Math.abs(e.x2 - n) && (n = e.x2);
                                    f[b] = z + (n - s)
                                } else z = l[b] ? l[b] : 0, s = n - z, n = q - z, a.dataSeriesIndexes.length - 1 === r && 1 >= Math.abs(e.x1 - s) && (s = e.x1), l[b] = z + (n - s);
                                b = t[k].color ? t[k].color : m._colorSet[k % m._colorSet.length];
                                ca(c, s, B, n, C, b, 0, null, x, !1, !1, !1, m.fillOpacity);
                                b = m.dataPointIds[k];
                                this._eventManager.objectMap[b] = {
                                    id: b,
                                    objectType: "dataPoint",
                                ...
                                b = Q(b);
                                v && ca(this._eventManager.ghostCtx, s, B, n, C, b, 0, null, !1, !1, !1, !1);
                                (t[k].indexLabel || m.indexLabel ||
                                    t[k].indexLabelFormatter || m.indexLabelFormatter) && this._indexLabels.push({
        ...
        m.prototype.renderArea = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var p = 0; p < a.dataSeriesIndexes.length; p++) {
                    ...
                    d = !0;
                    var h = 0,
                        m, t, s, F = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0),
                        B, C = null;
                    if (0 < r.length) {
                        ...
                        for (var ja = !0; h < r.length; h++)
                            if (s = r[h].x.getTime ? r[h].x.getTime() : r[h].x, !(s < a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax && (!g.connectNullData || !ja)))
                                if ("number" !== typeof r[h].y) g.connectNullData ||
                                    (ja || d) || b(), ja = !0;
                                else {
                                    ...
                                    0 !== r[h].markerSize && (0 < r[h].markerSize || 0 < g.markerSize) && (s = g.getMarkerProperties(h, m, t, f), A.push(s), aa = Q(aa),
                                        v && A.push({
                                            x: m,
                                            y: t,
                                            ctx: l,
                ...
                if (0 < c.length) {
                    if (0 <
                        ...
                        for (var d = 0; d < c.length - 3; d += 3)
                            if (b.bezierCurveTo(c[d + 1].x, c[d + 1].y, c[d + 2].x, c[d + 2].y, c[d + 3].x, c[d + 3].y), v && e.bezierCurveTo(c[d + 1].x, c[d + 1].y, c[d + 2].x, c[d + 2].y, c[d + 3].x, c[d + 3].y), c[d + 3].newStrokeStyle || c[d + 3].newLineDashArray) b.stroke(), b.beginPath(), b.moveTo(c[d + 3].x, c[d + 3].y), c[d + 3].newStrokeStyle && (b.strokeStyle = c[d + 3].newStrokeStyle),
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var A =
                    ...
                    var l = [],
                        ...
                        s = [];
                    if (0 < p.length) {
                        var F = n._colorSet[q % n._colorSet.length],
                            B = n.lineColor = n.options.lineColor || F,
                            C = B;
                        b.fillStyle = F;
                        b.strokeStyle = B;
                        ...
                        for (r = !1; q < p.length; q++)
                            if (g = p[q].x.getTime ? p[q].x.getTime() : p[q].x, !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax && (!n.connectNullData || !r)))
                                if ("number" !== typeof p[q].y) 0 < q && !r && (n.connectNullData ? b.setLineDash && (0 < s.length && (n.options.nullDataLineDashType || !p[q - 1].lineDashType)) && (s[s.length - 1].newLineDashArray = y, z = n.nullDataLineDashType) : (d(), s = [])), r = !0;
                                else {
                                    ...
                                    q < p.length - 1 && (C !== (p[q].lineColor || B) || z !== (p[q].lineDashType || n.lineDashType)) && (C = p[q].lineColor || B, s[s.length - 1].newStrokeStyle = C, b.setLineDash && (p[q].lineDashType ? (z = p[q].lineDashType, s[s.length - 1].newLineDashArray = N(z, n.lineThickness)) : (z = n.lineDashType, s[s.length - 1].newLineDashArray = D)));
        ...
        m.prototype.renderStepArea =
            function(a) {
                ...
                function b() {
                    C && (0 < g.lineThickness && f.stroke(), a.axisY.logarithmic || 0 >= a.axisY.viewportMinimum && 0 <= a.axisY.viewportMaximum ? B = F : 0 > a.axisY.viewportMaximum ? B = u.y1 : 0 < a.axisY.viewportMinimum && (B = F), f.lineTo(m, B), f.lineTo(C.x, B), f.closePath(), f.globalAlpha = g.fillOpacity, f.fill(), f.globalAlpha = 1, v && (l.lineTo(m, B), l.lineTo(C.x, B), l.closePath(), l.fill()), f.beginPath(), f.moveTo(m, t), l.beginPath(), l.moveTo(m, t), C = {
                        x: m,
                        y: t
                    })
                }
                ...
                if (!(0 >= a.dataSeriesIndexes.length)) {
                    ...
                    for (var p = 0; p < a.dataSeriesIndexes.length; p++) {
                        ...
                        d = !0;
                        var h = 0,
                            m, t, s, F = a.axisY.convertValueToPixel(a.axisY.logarithmic ?
                                a.axisY.viewportMinimum : 0),
                            B, C = null;
                        c = !1;
                        if (0 < r.length) {
                            ...
                            for (; h < r.length; h++)
                                if (s = r[h].x.getTime ? r[h].x.getTime() : r[h].x, !(s < a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax && (!g.connectNullData || !c))) {
                                    ...
                                    typeof r[h].y ? (g.connectNullData || (c || d) || b(), c = !0) : (m = a.axisX.convertValueToPixel(s), t = a.axisY.convertValueToPixel(r[h].y), d || c ? (!d && g.connectNullData ? (f.setLineDash && (g.options.nullDataLineDashType || S === g.lineDashType && g.lineDashType !== g.nullDataLineDashType) && (d = m, c = t, m = n.x, t = n.y, b(), f.moveTo(n.x, n.y), m = d, t = c, C = n, S = g.nullDataLineDashType, f.setLineDash(P)), f.lineTo(m, aa), f.lineTo(m, t), v && (l.lineTo(m, aa), l.lineTo(m, t))) : (f.beginPath(), f.moveTo(m, t), v && (l.beginPath(), l.moveTo(m, t)), C = {
                                        ...
                                        d = !1) : (f.lineTo(m, aa), v && l.lineTo(m, aa), f.lineTo(m, t), v && l.lineTo(m, t), 0 == h % 250 && b()), n = {
                                        x: m,
                                        y: t
                                        ...
                                        r[h].markerSize || 0 < g.markerSize) && (aa = g.getMarkerProperties(h, m, t, f), A.push(aa), s = Q(s), v && A.push({
                                        x: m,
                                        y: t,
                                        ctx: l,
                                        type: aa.type,
        ...
        m.prototype.renderStackedArea = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var e = null,
                    ...
                    p = [],
                    q = 0,
                    g, r, m = a.axisY.convertValueToPixel(a.axisY.logarithmic ?
                        a.axisY.viewportMinimum : 0),
                ...
                for (B = 0; B < a.dataSeriesIndexes.length; B++) {
                    ...
                    if (0 < n.length) {
                        ...
                        if (b.setLineDash) {
                            ...
                            F = z.lineDashType;
                            var D = N(F, z.lineThickness);
                            b.setLineDash(D)
                        }
                        for (var aa = !0, q = 0; q < n.length; q++) {
                            var f = n[q],
                                fa = null,
                                fa = 0 <= z.dataPointIndexes[f] ?
                                w[z.dataPointIndexes[f]] : {
                                    x: f,
                                    y: null
                                };
                            if (!(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax && (!z.connectNullData || !aa)))
                                if ("number" !== typeof fa.y) z.connectNullData || (aa || x) || d(), aa = !0;
                                    ...
                                    q < w.length - 1 &&
                                        (S !== (w[q].lineColor || y) || F !== (w[q].lineDashType || z.lineDashType)) && (d(), b.beginPath(), b.moveTo(g, r), k.push({
                                            x: g,
                                            y: m - la
                                        }), S = w[q].lineColor || y, b.strokeStyle = S, b.setLineDash && (w[q].lineDashType ? (F = w[q].lineDashType, b.setLineDash(N(F, z.lineThickness))) : (F = z.lineDashType, b.setLineDash(D))));
                                    if (0 <= z.dataPointIndexes[f]) {
                                        var E = z.dataPointIds[z.dataPointIndexes[f]];
                                    ...
                                    0 <= z.dataPointIndexes[f] &&
                                        0 !== fa.markerSize && (0 < fa.markerSize || 0 < z.markerSize) && (la = z.getMarkerProperties(z.dataPointIndexes[f], g, r, b), l.push(la), f = Q(E), v && l.push({
                                            x: g,
                                            y: r,
                                            ctx: s,
                                            type: la.type,
        ...
        m.prototype.renderStackedArea100 = function(a) {
            function d() {
                ...
                b.globalAlpha = 1;
                b.beginPath();
                v && (F.closePath(), F.fill(), F.beginPath());
                k = []
            }
            var c = a.targetCanvasCtx || this.plotArea.ctx,
                b = v ? this._preRenderCtx : c;
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                b.clip();
                v && (F.beginPath(), F.rect(l.x1, l.y1, l.width, l.height), F.clip());
                for (var e = [], B = 0; B < a.dataSeriesIndexes.length; B++) {
                ...
                for (B = 0; B < a.dataSeriesIndexes.length; B++) {
                    ...
                    if (0 < n.length) {
                        ...
                        if (b.setLineDash) {
                            var P = N(z.nullDataLineDashType, z.lineThickness);
                            t = z.lineDashType;
                            var E = N(t, z.lineThickness);
                            b.setLineDash(E)
                        }
                        for (var aa = !0, q = 0; q < n.length; q++) {
                            var f = n[q],
                                fa = null,
                                fa = 0 <= z.dataPointIndexes[f] ? y[z.dataPointIndexes[f]] : {
                                    x: f,
                                    y: null
                                };
                            if (!(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax && (!z.connectNullData || !aa)))
                                if ("number" !== typeof fa.y) z.connectNullData || (aa || s) || d(), aa = !0;
                                    ...
                                    h[f] = x - r;
                                    s || aa ? (!s && z.connectNullData ? (b.setLineDash && (z.options.nullDataLineDashType || t === z.lineDashType && z.lineDashType !== z.nullDataLineDashType) && (s = k.pop(), t = k[k.length - 1], d(), b.moveTo(m.x, m.y), k.push(t), k.push(s), t = z.nullDataLineDashType, b.setLineDash(P)), b.lineTo(g, r), v && F.lineTo(g, r)) : (b.beginPath(), b.moveTo(g, r), v && (F.beginPath(), F.moveTo(g, r))),
                                        aa = s = !1) : (b.lineTo(g, r), v && F.lineTo(g, r), 0 == q % 250 && (d(), b.moveTo(g, r), v && F.moveTo(g, r), k.push({
                                        x: g,
                                        y: x - ba
                                    })));
                                    m = {
                                    ...
                                    q < y.length - 1 && (S !== (y[q].lineColor || D) || t !== (y[q].lineDashType || z.lineDashType)) && (d(), b.beginPath(), b.moveTo(g, r), k.push({
                                        x: g,
                                        y: x - ba
                                    }), S = y[q].lineColor || D, b.strokeStyle = S, b.setLineDash && (y[q].lineDashType ? (t = y[q].lineDashType, b.setLineDash(N(t, z.lineThickness))) : (t = z.lineDashType, b.setLineDash(E))));
                                    if (0 <= z.dataPointIndexes[f]) {
                                    ...
                                    0 <= z.dataPointIndexes[f] && 0 !== fa.markerSize && (0 < fa.markerSize || 0 < z.markerSize) && (ba = z.getMarkerProperties(q, g, r, b), u.push(ba), f = Q(G), v && u.push({
                                        x: g,
                                        y: r,
                                        ctx: F,
                                        type: ba.type,
                ...
                W.drawMarkers(u);
                v && (c.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), b.globalCompositeOperation = "source-atop", a.axisX.maskCanvas && b.drawImage(a.axisX.maskCanvas, 0, 0, this.width, this.height), a.axisY.maskCanvas && b.drawImage(a.axisY.maskCanvas, 0, 0, this.width, this.height), this._breaksCanvasCtx && this._breaksCanvasCtx.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height),
                    b.clearRect(l.x1, l.y1, l.width, l.height), F.restore());
                b.restore();
                return {
                    source: c,
                    dest: this.plotArea.ctx,
        ...
        m.prototype.renderBubble = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var r = 25 * Math.PI, m = Math.max(Math.pow(0.25 * Math.min(b.height, b.width) / 2, 2) * Math.PI,
        ...
        m.prototype.renderScatter = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                c.rect(b.x1, b.y1, b.width, b.height);
                c.clip();
                v && (this._eventManager.ghostCtx.beginPath(), this._eventManager.ghostCtx.rect(b.x1, b.y1,
                        ...
                        for (var p = 0, q = 0, e = 0; e < n.length; e++)
                            if (f = n[e].getTime ? f = n[e].x.getTime() : f = n[e].x, !(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax) && "number" === typeof n[e].y) {
                                ...
                                Math.sqrt((p - f) * (p - f) + (q - l) * (q - l)) < Math.min(g.size, 5) && n.length > Math.min(this.plotArea.width, this.plotArea.height) || (p = k.dataPointIds[e], this._eventManager.objectMap[p] = {
                                    ...
                                    x1: f,
                                    y1: l
                                }, p = Q(p), v && W.drawMarker(g.x, g.y, this._eventManager.ghostCtx, g.type, g.size, p, p, g.borderThickness), (n[e].indexLabel || k.indexLabel ||
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var m = 0; m < a.dataSeriesIndexes.length; m++) {
                    var w = a.dataSeriesIndexes[m],
                        ...
                        x = t.dataPoints;
                    if (0 < x.length)
                        for (var F = 5 < r && t.bevelEnabled ? !0 : !1, u = 0; u < x.length; u++)
                            if (x[u].getTime ? g = x[u].x.getTime() : g = x[u].x, !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax) && !s(x[u].y) && x[u].y.length && "number" === typeof x[u].y[0] && "number" === typeof x[u].y[1] && "number" === typeof x[u].y[2] && "number" === typeof x[u].y[3]) {
                                ...
                                "candlestick" === t.type ? (c.moveTo(h - y, n), c.lineTo(h - y, Math.min(k, q)), c.stroke(), c.moveTo(h -
                                    ...
                                    c.stroke(), v && (e = Q(D), b.strokeStyle = e, b.moveTo(h - y, n), b.lineTo(h - y, p), b.stroke(), b.beginPath(), b.moveTo(h, k), b.lineTo(B, k), b.stroke(), b.beginPath(), b.moveTo(h, q), b.lineTo(C, q), b.stroke()));
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var m = !1, m = !!a.axisY.reversed, w = 0; w < a.dataSeriesIndexes.length; w++) {
                    var t = a.dataSeriesIndexes[w],
                        ...
                        F = x.dataPoints;
                    if (0 < F.length)
                        for (var B = 5 < r && x.bevelEnabled ? !0 : !1, l = 0; l < F.length; l++)
                            if (F[l].getTime ? g = F[l].x.getTime() : g = F[l].x, !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax) && !s(F[l].y) && F[l].y.length && "number" === typeof F[l].y[0] && "number" === typeof F[l].y[1] && "number" === typeof F[l].y[2] &&
                                "number" === typeof F[l].y[3] && "number" === typeof F[l].y[4] && 5 === F[l].y.length) {
                                u = a.axisX.convertValueToPixel(g);
                                h = a.axisY.convertValueToPixel(F[l].y[0]);
                                k = a.axisY.convertValueToPixel(F[l].y[1]);
                                n = a.axisY.convertValueToPixel(F[l].y[2]);
                                p = a.axisY.convertValueToPixel(F[l].y[3]);
                                q = a.axisY.convertValueToPixel(F[l].y[4]);
                                var C = u - r / 2 << 0,
                                    z = u + r / 2 << 0,
                                    e = F[l].color ? F[l].color : x._colorSet[0],
                                    y = Math.round(Math.max(1, 0.15 * r)),
                                    D = 0 === y % 2 ? 0 : 0.5,
                                    S = F[l].whiskerColor ? F[l].whiskerColor : F[l].color ? x.whiskerColor ? x.whiskerColor :
                                    F[l].color : x.whiskerColor ? x.whiskerColor : e,
                                    P = "number" === typeof F[l].whiskerThickness ? F[l].whiskerThickness : "number" === typeof x.options.whiskerThickness ? x.whiskerThickness : y,
                                    E = F[l].whiskerDashType ? F[l].whiskerDashType : x.whiskerDashType,
                                    aa = s(F[l].whiskerLength) ? s(x.options.whiskerLength) ? r : x.whiskerLength : F[l].whiskerLength,
                                    aa = "number" === typeof aa ? 0 >= aa ? 0 : aa >= r ? r : aa : "string" === typeof aa ? parseInt(aa) * r / 100 > r ? r : parseInt(aa) * r / 100 : r,
                                    fa = 1 === Math.round(P) % 2 ? 0.5 : 0,
                                    la = F[l].stemColor ? F[l].stemColor : F[l].color ?
                                    x.stemColor ? x.stemColor : F[l].color : x.stemColor ? x.stemColor : e,
                                    ba = "number" === typeof F[l].stemThickness ? F[l].stemThickness : "number" === typeof x.options.stemThickness ? x.stemThickness : y,
                                    G = 1 === Math.round(ba) % 2 ? 0.5 : 0,
                                    H = F[l].stemDashType ? F[l].stemDashType : x.stemDashType,
                                    J = F[l].lineColor ? F[l].lineColor : F[l].color ? x.lineColor ? x.lineColor : F[l].color : x.lineColor ? x.lineColor : e,
                                    M = "number" === typeof F[l].lineThickness ? F[l].lineThickness : "number" === typeof x.options.lineThickness ? x.lineThickness : y,
                                    T = F[l].lineDashType ?
                                    F[l].lineDashType : x.lineDashType,
                                ...
                                c.save();
                                0 < ba && (c.beginPath(), c.strokeStyle = la, c.lineWidth = ba,
                                    c.setLineDash && c.setLineDash(N(H, ba)), c.moveTo(u - G, k), c.lineTo(u - G, h), c.stroke(), c.moveTo(u - G, p), c.lineTo(u - G, n), c.stroke());
                                c.restore();
                                b.lineWidth = Math.max(y, 4);
                                c.beginPath();
                                ca(c, C, Math.min(q, k), z, Math.max(k, q), wa, 0, e, m ? B : !1, m ? !1 : B, !1, !1, ra);
                                c.beginPath();
                                ca(c, C, Math.min(n, q), z, Math.max(q, n), R, 0, e, m ? !1 : B, m ? B : !1, !1, !1, ra);
                                c.beginPath();
                                c.lineWidth = y;
                                c.strokeStyle = e;
                                ...
                                c.stroke();
                                c.save();
                                0 < M && (c.beginPath(), c.globalAlpha = 1, c.setLineDash &&
                                    c.setLineDash(N(T, M)), c.strokeStyle = J, c.lineWidth = M, c.moveTo(C, q - K), c.lineTo(z, q - K), c.stroke());
                                c.restore();
                                c.save();
                                0 < P && (c.beginPath(), c.setLineDash && c.setLineDash(N(E, P)), c.strokeStyle = S, c.lineWidth = P, c.moveTo(u - aa / 2 << 0, p - fa), c.lineTo(u + aa / 2 << 0, p - fa), c.stroke(), c.moveTo(u - aa / 2 << 0, h + fa), c.lineTo(u + aa / 2 << 0, h + fa), c.stroke());
                                c.restore();
                                v && (e = Q(O), b.strokeStyle = e, b.lineWidth = ba, 0 < ba && (b.moveTo(u - D - G, k), b.lineTo(u - D - G, Math.max(h, p)), b.stroke(), b.moveTo(u - D - G, Math.min(h, p)), b.lineTo(u - D - G, n), b.stroke()),
                                    ca(b, C, Math.max(k, n), z, Math.min(k, n), e, 0, null, !1, !1, !1, !1), 0 < P && (b.beginPath(), b.lineWidth = P, b.moveTo(u + aa / 2, p - fa), b.lineTo(u - aa / 2, p - fa), b.stroke(), b.moveTo(u + aa / 2, h + fa), b.lineTo(u - aa / 2, h + fa), b.stroke()));
                                (F[l].indexLabel || x.indexLabel || F[l].indexLabelFormatter || x.indexLabelFormatter) && this._indexLabels.push({
                                    chartType: x.type,
                                    dataPoint: F[l],
                                    dataSeries: x,
                                    point: {
        ...
        m.prototype.renderRangeColumn = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var b = null,
                    e = this.plotArea,
                    f = 0,
                    l, u, h, f = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1;
                ...
                for (var n = 0; n < a.dataSeriesIndexes.length; n++) {
                    ...
                    if (0 < g.length)
                        for (var r = 5 < k && q.bevelEnabled ? !0 : !1, f = 0; f < g.length; f++)
                            if (g[f].getTime ? h = g[f].x.getTime() : h = g[f].x, !(h < a.axisX.dataInfo.viewPortMin || h > a.axisX.dataInfo.viewPortMax) && !s(g[f].y) && g[f].y.length && "number" ===
        ...
        m.prototype.renderError = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var x = 0; x <
                    ...
                    var F = a.dataSeriesIndexes[x],
                        B = this.data[F],
                        C = B.dataPoints,
                        z = s(B._linkedSeries) ? !1 : B._linkedSeries.type.match(/(bar|column)/ig) && B._linkedSeries.visible ? !0 : !1,
                        D = 0;
                    if (z)
                        for (e = B._linkedSeries.id, t = 0; t < e; t++) !this.data[t].type.match(/(bar|column)/ig) || !this.data[t].visible || this.data[t].type.match(/(stacked)/ig) && D || (this.data[t].type.match(/(range)/ig) && (f = !0), D++);
                    e = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth :
                        1;
                    u = this.options.dataPointMaxWidth ? this.dataPointMaxWidth : this.options.dataPointWidth ? this.dataPointWidth : b ? Math.min(0.15 * this.height, 0.9 * (this.plotArea.height / (z ? w : 1))) << 0 : 0.3 * this.width;
                    f && (u = this.options.dataPointMaxWidth ? this.dataPointMaxWidth : this.options.dataPointWidth ? this.dataPointWidth : b ? Math.min(0.15 * this.height, 0.9 * (this.plotArea.height / (z ? w : 1))) << 0 : 0.03 * this.width);
                    t = this.options.dataPointWidth ? this.dataPointWidth : 0.9 * ((b ? l.height : l.width) * (a.axisX.logarithmic ? Math.log(m) / Math.log(a.axisX.range) :
                        Math.abs(m) / Math.abs(a.axisX.range)) / (z ? w : 1)) << 0;
                    ...
                    t > u && (t = u);
                    if (0 < C.length)
                        for (var E = B._colorSet, u = 0; u < C.length; u++) {
                            var e = B.lineColor = B.options.color ? B.options.color : E[0],
                                S = {
                                    color: C[u].whiskerColor ? C[u].whiskerColor : C[u].color ? B.whiskerColor ? B.whiskerColor : C[u].color : B.whiskerColor ? B.whiskerColor : e,
                                    thickness: s(C[u].whiskerThickness) ? B.whiskerThickness : C[u].whiskerThickness,
                                    dashType: C[u].whiskerDashType ? C[u].whiskerDashType : B.whiskerDashType,
                                    length: s(C[u].whiskerLength) ? s(B.options.whiskerLength) ? t : B.options.whiskerLength : C[u].whiskerLength,
                                    trimLength: s(C[u].whiskerLength) ? s(B.options.whiskerLength) ? 50 : 0 : 0
                                };
                            ...
                            var P = {
                                color: C[u].stemColor ? C[u].stemColor : C[u].color ? B.stemColor ? B.stemColor : C[u].color : B.stemColor ? B.stemColor : e,
                                thickness: C[u].stemThickness ? C[u].stemThickness : B.stemThickness,
                                dashType: C[u].stemDashType ? C[u].stemDashType : B.stemDashType
                            };
                            ...
                            if (!(r < a.axisX.dataInfo.viewPortMin || r > a.axisX.dataInfo.viewPortMax) &&
                                ...
                                b ? p = ja : g = ja;
                                b ? (q = a.axisX.reversed ? k + (z ? w : 1) * t / 2 - (z ? D - 1 : 0) * t << 0 : k - (z ? w : 1) * t / 2 + (z ? D - 1 : 0) * t << 0, g = a.axisX.reversed ? q - t << 0 : q + t << 0) : (n = a.axisX.reversed ? h + (z ? w : 1) * t / 2 - (z ? D - 1 : 0) * t << 0 : h - (z ? w : 1) * t / 2 + (z ? D - 1 : 0) * t << 0, p = a.axisX.reversed ? n - t << 0 : n + t << 0);
                                !b && q > g && (ja = q, q = g, g = ja);
                                b && n > p &&
                                    (ja = n, n = p, p = ja);
                                ja = B.dataPointIds[u];
                                ...
                                if (C[u].indexLabel || B.indexLabel || C[u].indexLabelFormatter || B.indexLabelFormatter) this._indexLabels.push({
                                    chartType: "error",
                                    dataPoint: C[u],
                                    dataSeries: B,
                                    indexKeyword: 0,
                    ...
                    if (0 < r.length) {
                        ...
                        for (f = 0; f < r.length; f++)
                            if (r[f].getTime ? k = r[f].x.getTime() : k = r[f].x, !(k < a.axisX.dataInfo.viewPortMin || k > a.axisX.dataInfo.viewPortMax) && !s(r[f].y) && r[f].y.length && "number" === typeof r[f].y[0] && "number" === typeof r[f].y[1]) {
                                ...
                                if (r[f].indexLabel || g.indexLabel || r[f].indexLabelFormatter ||
                                    g.indexLabelFormatter) this._indexLabels.push({
                                    chartType: "rangeBar",
                                    dataPoint: r[f],
                                    dataSeries: g,
                                    indexKeyword: 0,
                ...
                for (var u = 0; u < a.dataSeriesIndexes.length; u++) {
                    ...
                    if (0 < p.length) {
                        var w = n._colorSet[g % n._colorSet.length],
                            B = n.lineColor = n.options.lineColor || w,
                            C = B;
                        b.fillStyle = w;
                        b.strokeStyle = B;
                        b.lineWidth = n.lineThickness;
                        ...
                        for (var S = !0; g < p.length; g++)
                            if (t = p[g].x.getTime ? p[g].x.getTime() : p[g].x, !(t < a.axisX.dataInfo.viewPortMin || t > a.axisX.dataInfo.viewPortMax && (!n.connectNullData ||
                                    !S)))
                                if (null !== p[g].y && p[g].y.length && "number" === typeof p[g].y[0] && "number" === typeof p[g].y[1]) {
                                    ...
                                    q || S ? (n.connectNullData && !q ? (b.setLineDash && (n.options.nullDataLineDashType || z === n.lineDashType && n.lineDashType !== n.nullDataLineDashType) && (h[h.length - 1].newLineDashArray = D, z = n.nullDataLineDashType, b.setLineDash(y)), b.lineTo(r, m), v && e.lineTo(r, m), h.push({
                                        x: r,
                                        y1: m,
                                        y2: s
                                    })) : (b.beginPath(), b.moveTo(r,
                                        m), x = {
                                        x: r,
                                        y: m
                                    }, h = [], h.push({
                                    ...
                                    g < p.length - 1 && (C !== (p[g].lineColor || B) || z !== (p[g].lineDashType || n.lineDashType)) && (d(), C = p[g].lineColor || B, h[h.length - 1].newStrokeStyle = C, b.strokeStyle = C, b.setLineDash && (p[g].lineDashType ? (z = p[g].lineDashType, h[h.length -
                                        1].newLineDashArray = N(z, n.lineThickness), b.setLineDash(h[h.length - 1].newLineDashArray)) : (z = n.lineDashType, h[h.length - 1].newLineDashArray = D, b.setLineDash(D))));
        ...
        m.prototype.renderRangeSplineArea = function(a) {
            function d(a, c) {
                ...
                if (0 < d.length) {
                    ...
                    for (f = d.length - 1; 2 < f; f -= 3) b.bezierCurveTo(d[f - 1].x, d[f - 1].y, d[f - 2].x, d[f - 2].y, d[f - 3].x, d[f - 3].y), v && e.bezierCurveTo(d[f - 1].x, d[f - 1].y, d[f - 2].x, d[f -
                        2].y, d[f - 3].x, d[f - 3].y);
                    b.closePath();
                ...
                for (var h = 0; h < a.dataSeriesIndexes.length; h++) {
                    ...
                    if (0 < n.length) {
                        var t = k._colorSet[p % k._colorSet.length],
                            x = k.lineColor = k.options.lineColor ||
                            t,
                            F = x;
                        b.fillStyle = t;
                        b.lineWidth = k.lineThickness;
                        ...
                        for (g = !1; p < n.length; p++)
                            if (q = n[p].x.getTime ? n[p].x.getTime() : n[p].x, !(q < a.axisX.dataInfo.viewPortMin || q > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !g)))
                                if (null !== n[p].y && n[p].y.length && "number" === typeof n[p].y[0] && "number" === typeof n[p].y[1]) {
                                    ...
                                    p < n.length - 1 && (F !== (n[p].lineColor || x) || B !== (n[p].lineDashType || k.lineDashType)) && (F = n[p].lineColor || x, s[s.length - 1].newStrokeStyle = F, b.setLineDash && (n[p].lineDashType ? (B = n[p].lineDashType, s[s.length - 1].newLineDashArray = N(B, k.lineThickness)) : (B = k.lineDashType, s[s.length - 1].newLineDashArray = C)));
                                    if (0 !== n[p].markerSize && (0 <
                                            n[p].markerSize || 0 < k.markerSize)) {
                                    ...
                                    g = !1
                                } else 0 < p && !g && (k.connectNullData ? b.setLineDash && (0 < s.length && (k.options.nullDataLineDashType || !n[p - 1].lineDashType)) && (s[s.length - 1].newLineDashArray = z, B = k.nullDataLineDashType) : (d(C, x), s = [], y = [])), g = !0;
                        d(C, x);
                        W.drawMarkers(f)
                    }
                }
        ...
        m.prototype.renderWaterfall = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                m = this.options.dataPointMaxWidth ? this.dataPointMaxWidth : this.options.dataPointWidth ? this.dataPointWidth :
                ...
                !this.dataPointMaxWidth && (this.dataPointMinWidth && m < l) &&
                    (m = Math.max(this.options.dataPointWidth ? this.dataPointWidth : -Infinity, l));
                q < l && (q = l);
                q > m && (q = m);
                c.save();
                v && this._eventManager.ghostCtx.save();
                ...
                for (var g = 0; g < a.dataSeriesIndexes.length; g++) {
                    var r = a.dataSeriesIndexes[g],
                        ...
                        w = s.dataPoints,
                        e = s._colorSet[0];
                    s.risingColor = s.options.risingColor ? s.options.risingColor :
                        e;
                    ...
                    if (0 < w.length)
                        for (var F = 5 < q && s.bevelEnabled ? !0 : !1, B = !1, y = null, z = null, l = 0; l < w.length; l++)
                            if (w[l].getTime ? n = w[l].x.getTime() : n = w[l].x, "number" !== typeof w[l].y) {
                                ...
                                ca(c, h, m, E, k, S, 0, S, F, F, !1, !1, s.fillOpacity);
                                e = Q(e);
                                v && ca(this._eventManager.ghostCtx, h, m, E, k, e, 0, null, !1, !1, !1, !1);
                                var P, S = h;
                                ...
                                0 < l && y && (!B || s.connectNullData) && (B && c.setLineDash && c.setLineDash(N(D,
                                    t)), c.beginPath(), c.moveTo(y, z - x), c.lineTo(S, P - x), 0 < t && c.stroke(), v && (b.beginPath(), b.moveTo(y, z - x), b.lineTo(S, P - x), 0 < t && b.stroke()));
                                B = !1;
                                y = E;
                                z = 0 < w[l].y ? m : k;
        ...
        var X = function(a, d, c, b, e, f, l, h, m) {
            if (!(0 > c)) {
                ...
                a.save();
                a.globalAlpha = h;
                "pie" === e ? (a.beginPath(), a.moveTo(d.x, d.y), a.arc(d.x, d.y,
                    c, f, l, !1), a.fillStyle = b, a.strokeStyle = "white", a.lineWidth = 2, a.closePath(), a.fill()) : "doughnut" === e && (a.beginPath(), a.arc(d.x, d.y, c, f, l, !1), 0 <= m && a.arc(d.x, d.y, m * c, l, f, !0), a.closePath(), a.fillStyle = b, a.strokeStyle = "white", a.lineWidth = 2, a.fill());
                a.globalAlpha = 1;
                a.restore()
            }
        };
        m.prototype.renderPie = function(a) {
            function d() {
                if (k && n) {
                    for (var a = 0, b = 0, c = 0, d = 0, e = 0; e < n.length; e++) {
                        ...
                        p.indexLabelFontColor = f.indexLabelFontColor ? f.indexLabelFontColor :
                        ...
                        p.indexLabelBackgroundColor = f.indexLabelBackgroundColor ? f.indexLabelBackgroundColor : k.options.indexLabelBackgroundColor ?
                        ...
                        p.startAngle = (p.startAngle + 2 * Math.PI) %
                            (2 * Math.PI);
                    ...
                    l = f = 0;
                    h = !1;
                    for (e = 0; e < n.length; e++) p = g[(c + e) % n.length], 1 < a && (p.midAngle > Math.PI / 2 - t && p.midAngle < Math.PI / 2 + t) && (f <= a / 2 && !h ? (p.hemisphere = "right", f++) : (p.hemisphere = "left",
                        h = !0));
                    h = !1;
            ...
            function c(a) {
                ...
                for (b = 0; b < n.length; b++) {
                    ...
                    if (d > c) {
                        ...
                        } else if (0 < Math.abs(g[b].center.x - F.x) || 0 < Math.abs(g[b].center.y - F.y)) g[b].center.x = F.x + e * (1 - a), g[b].center.y = F.y + f * (1 - a), l = !0;
            ...
            function e(a) {
                for (var c = null, d = 1; d < n.length; d++)
                    if (c = (a + d + g.length) % g.length, g[c].hemisphere !== g[a].hemisphere) {
                        c = null;
                        break
                    } else if (g[c].indexLabelText && c !== a && (0 > b(g[c], g[a]) ||
                        ("right" === g[a].hemisphere ? g[c].indexLabelTextBlock.y >= g[a].indexLabelTextBlock.y : g[c].indexLabelTextBlock.y <= g[a].indexLabelTextBlock.y))) break;
                else c = null;
                return c
            }
            ...
            function f(a, c, d) {
                ...
                if (0 <= a && a < n.length) {
                    ...
                    var q = 0,
                        u = 0,
                        u = q = q = 0;
                    0 > c ? h.indexLabelTextBlock.y - h.indexLabelTextBlock.height / 2 > l && h.indexLabelTextBlock.y - h.indexLabelTextBlock.height / 2 + c < l && (c = -(l -
                        (h.indexLabelTextBlock.y - h.indexLabelTextBlock.height / 2 + c))) : h.indexLabelTextBlock.y + h.indexLabelTextBlock.height / 2 < l && h.indexLabelTextBlock.y + h.indexLabelTextBlock.height / 2 + c > p && (c = h.indexLabelTextBlock.y + h.indexLabelTextBlock.height / 2 + c - p);
                    c = h.indexLabelTextBlock.y + c;
                    l = 0;
                    l = "right" === h.hemisphere ? F.x + Math.sqrt(Math.pow(v, 2) - Math.pow(c - F.y, 2)) : F.x - Math.sqrt(Math.pow(v, 2) - Math.pow(c - F.y, 2));
                    u = F.x + z * Math.cos(h.midAngle);
                    q = F.y + z * Math.sin(h.midAngle);
                    ...
                    q = e(a);
                    p = l = 0;
                    0 > c ? (p = "right" === h.hemisphere ? u : q, k = c, null !== p && (u = -c, c = h.indexLabelTextBlock.y -
                    ...
                    k && (d = h.indexLabelTextBlock.y + k, c = 0, c = "right" === h.hemisphere ? F.x + Math.sqrt(Math.pow(v,
                ...
                for (var c = a = 0, d = 0, l = !0, c =
                    ...
                    if ("inside" !== k.indexLabelPlacement) {
                        ...
                        for (a = 0; a < n.length; a++) {
                            var h = g[a];
                            h.indexLabelTextBlock.x = F.x + v * Math.cos(h.midAngle);
                            h.indexLabelTextBlock.y = F.y + v * Math.sin(h.midAngle);
                            ...
                            if (null !== t) {
                                ...
                                if (0 > B) {
                                    for (var y = s = 0, C = 0; C < n.length; C++) C !==
                                        a && g[C].hemisphere === h.hemisphere && (g[C].indexLabelTextBlock.y < h.indexLabelTextBlock.y ? s++ : y++);
                                    s = B / (s + y || 1) * y;
                                    var y = -1 * (B - s),
                                        H = C = 0;
                                    "right" === h.hemisphere ? (C = f(a, s), y = -1 * (B - C), H = f(t, y), +H.toFixed(x) < +y.toFixed(x) && +C.toFixed(x) <= +s.toFixed(x) && f(a, -(y - H))) : (C = f(t, s), y = -1 * (B - C), H = f(a, y), +H.toFixed(x) < +y.toFixed(x) && +C.toFixed(x) <= +s.toFixed(x) && f(t, -(y - H)))
                                }
                            }
                        }
                    } else
                        for (a = 0; a < n.length; a++) h = g[a], v = "pie" === k.type ? 0.7 * z : 0.8 * z, t = F.x + v * Math.cos(h.midAngle), s = F.y + v * Math.sin(h.midAngle), h.indexLabelTextBlock.x =
                            t, h.indexLabelTextBlock.y = s;
                    for (a = 0; a < n.length; a++)
                        if (h = g[a], t = h.indexLabelTextBlock.measureText(), 0 !== t.height && 0 !== t.width) t = t = 0, "right" === h.hemisphere ? (t = q.x2 - (h.indexLabelTextBlock.x + h.indexLabelTextBlock.width + p), t *= -1) : t = q.x1 - (h.indexLabelTextBlock.x - h.indexLabelTextBlock.width - p), 0 < t && (!l && h.indexLabelText && (s = "right" === h.hemisphere ? q.x2 - h.indexLabelTextBlock.x : h.indexLabelTextBlock.x - q.x1, 0.3 * h.indexLabelTextBlock.maxWidth > s ? h.indexLabelText = "" : h.indexLabelTextBlock.maxWidth = 0.85 * s, 0.3 * h.indexLabelTextBlock.maxWidth <
                            ...
                            h.indexLabelAngle < Math.PI ? -1 : 1, 0 === f(a, t * s) && f(a, 2 * s)), Math.abs(h.indexLabelTextBlock.x - F.x) < z && (t /= Math.abs(Math.sin(h.indexLabelAngle)), 9 < t && (t *= 0.3), t > d && (d = t)));
                            ...
                            if (f = !1, u = g[k], u.indexLabelText) {
                                ...
                                if (null !== l) {
                                    ...
                                    if (q = 0 > B) {
                                        ...
                                        q = u.indexLabelTextBlock.x + u.indexLabelTextBlock.width < h.indexLabelTextBlock.x - p ||
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var k = this.data[a.dataSeriesIndexes[0]],
                    ...
                    B = 0;
                a = !1;
                for (var y = 0; y < n.length; y++) B += Math.abs(n[y].y), !a && ("undefined" !== typeof n[y].indexLabel && null !== n[y].indexLabel && 0 < n[y].indexLabel.toString().length) &&
                    (a = !0), !a && ("undefined" !== typeof n[y].label && null !== n[y].label && 0 < n[y].label.toString().length) && (a = !0);
                if (0 !== B) {
        ...
        var pa = function(a, d, c, b) {
            ...
            0 >= Math.round(d.y4 - d.y1) || (a.save(), a.globalAlpha = c, a.beginPath(), a.moveTo(Math.round(d.x1), Math.round(d.y1)), a.lineTo(Math.round(d.x2), Math.round(d.y2)), a.lineTo(Math.round(d.x3), Math.round(d.y3)), a.lineTo(Math.round(d.x4), Math.round(d.y4)),
        ...
        m.prototype.renderFunnel = function(a) {
            ...
            function c() {
                ...
                if (0 === g) return -1;
                for (var l = d[0] = 0, n = 0, h, p, b = b - a, l = !1, k = 0; k < x.length; k++) a = Math.abs(x[k].y) * f / g, l ? h = 0 == Number(c.toFixed(3)) ? 0 : a / c : (p = $ * $ * b * b - 4 * Math.abs($) * a, 0 > p ? (p = c, l = (b + p) * (e - n) / 2, a -= l, h = e - n, n += e - n, h += 0 == p ? 0 : a / p, n += a / p, l = !0) : (h = (Math.abs($) * b - Math.sqrt(p)) / 2, p = b - 2 * h / Math.abs($), n +=
                    h, n > e && (n -= h, p = c, l = (b + p) * (e - n) / 2, a -= l, h = e - n, n += e - n, h += a / p, n += a / p, l = !0), b = p)), d.push(h);
                return d
            }

            function b() {
                if (t && x) {
                    for (var a, b, c, d, e, f, k, l, n, h, p, q, u, m, r, A = [], w = [], B = {
                            percent: null,
                            total: null
                        }, F = null, z = 0; z < x.length; z++) r = O[z], r = "undefined" !== typeof r.x5 ? (r.y2 + r.y4) / 2 : (r.y2 + r.y3) / 2, r = g(r).x2 + 1, A[z] = J - r - V;
                    r = 0.5 * V;
                    for (var z = 0, C = x.length - 1; z < x.length || 0 <= C; z++, C--) {
                        ...
                        m = b.indexLabelTextAlign || t.indexLabelTextAlign || "left";
                        ...
                        a = b.indexLabelLineColor || t.options.indexLabelLineColor ||
                            a;
                        ...
                        "inside" === t.indexLabelPlacement &&
                            (A[z] = z !== ca ? t.reversed ? O[z].x2 - O[z].x1 : O[z].x3 - O[z].x4 : O[z].x3 - O[z].x6, 20 > A[z] && (A[z] = z !== ca ? t.reversed ? O[z].x3 - O[z].x4 : O[z].x2 - O[z].x1 : O[z].x2 - O[z].x1, A[z] /= 2));
                        u = b.indexLabelMaxWidth ? b.indexLabelMaxWidth : t.options.indexLabelMaxWidth ? t.indexLabelMaxWidth : A[z];
                        if (u > A[z] || 0 > u) u = A[z];
                        w[z] = "inside" === t.indexLabelPlacement ? O[z].height : !1;
                        B = y.getPercentAndTotal(t, b);
                        if (t.indexLabelFormatter || b.indexLabelFormatter) F = {
                            chart: y.options,
                            dataSeries: t,
                            dataPoint: b,
                            total: B.total,
                        ...
                        b = b.indexLabelFormatter ?
                            b.indexLabelFormatter(F) : b.indexLabel ? y.replaceKeywordsWithValue(b.indexLabel, b, t, z) : t.indexLabelFormatter ? t.indexLabelFormatter(F) : t.indexLabel ? y.replaceKeywordsWithValue(t.indexLabel, b, t, z) : b.label ? b.label : "";
                        0 >= h && (h = 0);
                        1E3 > u && 1E3 - u < r && (u += 1E3 - u);
                        R.roundRect || Aa(R);
                        c = new ia(R, {
                            fontSize: f,
                            fontFamily: l,
            ...
            function f() {
                ...
                if ("inside" !== t.indexLabelPlacement)
                    for (var e = 0; e < O.length; e++) 0 == I[e].textBlock.text.length ? I[e].isDirty = !0 : (a = O[e], c = "undefined" !== typeof a.x5 ? (a.y2 + a.y4) / 2 : (a.y2 + a.y3) / 2, b = t.reversed ? "undefined" !== typeof a.x5 ? c > wa ? g(c).x2 + 1 : (a.x2 + a.x3) / 2 + 1 : (a.x2 + a.x3) / 2 + 1 : "undefined" !== typeof a.x5 ? c < wa ? g(c).x2 + 1 : (a.x4 + a.x3) /
                        2 + 1 : (a.x2 + a.x3) / 2 + 1, I[e].textBlock.x = b + V, I[e].textBlock.y = c - I[e].height / 2, t.reversed ? (I[e].textBlock.y + I[e].height > ma + B && (I[e].textBlock.y = ma + B - I[e].height), I[e].textBlock.y < ra - B && (I[e].textBlock.y = ra - B)) : (I[e].textBlock.y < ma - B && (I[e].textBlock.y = ma - B), I[e].textBlock.y + I[e].height > ra + B && (I[e].textBlock.y = ra + B - I[e].height)));
                else
                    for (e = 0; e < O.length; e++) 0 == I[e].textBlock.text.length ? I[e].isDirty = !0 : (a = O[e], b = a.height, c = I[e].height, d = I[e].width, b >= c ? (b = e != ca ? (a.x4 + a.x3) / 2 - d / 2 : (a.x5 + a.x4) / 2 - d / 2, c = e !=
            ...
            function l() {
                ...
                for (var d, e, f, g, k, l, n = 1, m = 0; m < 2 * n; m++) {
                    for (var r =
                            I.length - 1; 0 <= r && !(0 <= p(r) && p(r), f = I[r], g = f.textBlock, l = (k = q(r) < O.length ? I[q(r)] : null) ? k.textBlock : null, d = +f.height.toFixed(6), e = +g.y.toFixed(6), !f.isDirty && (k && e + d + da > +l.y.toFixed(6)) && (d = g.y + d + da - l.y, e = a(r, -d), e < d && (0 < e && (d -= e), e = a(q(r), d), e != d))); r--);
                    b()
                }
            }

            function h(a, b) {
                return (b < O.length ? I[b].textBlock.y : t.reversed ? ma + B : ra + B) - (0 > a ? t.reversed ? ra - B : ma - B : I[a].textBlock.y + I[a].height + da)
            }

            function m(a, b, c) {
                var d, e, g, l = [],
                    h = B,
                    p = []; - 1 !== b && (0 <= X.indexOf(b) ? (e = X.indexOf(b), X.splice(e, 1)) : (X.push(b),
                ...
                a._animator.animate(0, c, function(c) {
                    ...
                    ha = !0;
                    d.clearRect(F.x1, F.y1, F.x2 - F.x1, F.y2 - F.y1);
                    d.fillStyle = a.backgroundColor;
                    d.fillRect(F.x1, F.y1, F.width, F.height);
                    u.changeSection(c, b);
                    var e = {};
                    e.dataSeries = t;
                    e.dataPoint = t.reversed ? t.dataPoints[x.length - 1 - b] :
                        t.dataPoints[b];
            ...
            var y = this;
            if (!(0 >= a.dataSeriesIndexes.length)) {
                for (var t = this.data[a.dataSeriesIndexes[0]], x = t.dataPoints, F = this.plotArea, B = 0.025 * F.width, C = 0.01 * F.width, z = 0, D = F.height - 2 * B, E = Math.min(F.width - 2 * C, 2.8 * F.height), H = !1, P = 0; P < x.length; P++)
                    if (!H &&
                        ("undefined" !== typeof x[P].indexLabel && null !== x[P].indexLabel && 0 < x[P].indexLabel.toString().length) && (H = !0), !H && ("undefined" !== typeof x[P].label && null !== x[P].label && 0 < x[P].label.toString().length) && (H = !0), !H && "function" === typeof t.indexLabelFormatter || "function" === typeof x[P].indexLabelFormatter) H = !0;
                H = H || "undefined" !== typeof t.indexLabel && null !== t.indexLabel && 0 < t.indexLabel.toString().length;
                "inside" !== t.indexLabelPlacement && H || (C = (F.width - 0.75 * E) / 2);
                var P = F.x1 + C,
                    J = F.x2 - C,
                    M = F.y1 + B,
                    Q = F.y2 - B,
                ...
                if (0 != t.length && (t.dataPoints && t.visible) && 0 !== x.length) {
                    ...
                    if (-1 !== P) {
                        if (t.reversed)
                            for (E.push(U), G = P.length - 1; 0 < G; G--) U += P[G], E.push(U);
                        else
                            for (G = 0; G < P.length; G++) U += P[G], E.push(U);
                        if (t.reversed)
                            for (G = 0; G < P.length; G++) E[G] < wa ? (a.push(K), C.push(W), ca = G) : (a.push((E[G] - ma + $ * Y) / $), C.push((E[G] - ma + ea * Z) / ea));
                        else
                            for (G = 0; G < P.length; G++) E[G] < wa ? (a.push((E[G] -
                                ma + $ * Y) / $), C.push((E[G] - ma + ea * Z) / ea), ca = G) : (a.push(K), C.push(W));
                        ...
                        R.clearRect(F.x1, F.y1, F.width, F.height);
                        R.fillStyle = y.backgroundColor;
                        R.fillRect(F.x1, F.y1, F.width, F.height);
                        if (H && t.visible && (b(), f(), e(), "inside" !== t.indexLabelPlacement)) {
                            ...
                            for (G = 0; G < O.length; G++) O[G].x1 += z, O[G].x2 += z, O[G].x3 += z, O[G].x4 += z, O[G].x5 && (O[G].x5 +=
                        ...
                        if (!H)
                            for (G = 0; G < x.length; G++) z = t.dataPointIds[G], a = {
                                id: z,
                                objectType: "dataPoint",
                                dataPointIndex: G,
                                dataSeriesIndex: 0,
        ...
        m.prototype.exportChart = function(a) {
            ...
            if (b && d && c) {
                ...
                if ("undefined" !== typeof Blob && new Blob) {
                    for (var l =
                            b.replace(/^data:[a-z\/]*;base64,/, ""), l = atob(l), h = new ArrayBuffer(l.length), h = new Uint8Array(h), m = 0; m < l.length; m++) h[m] = l.charCodeAt(m);
                    d = new Blob([h.buffer], {
                        type: "image/" + d
                    });
                    try {
        ...
        m.prototype.getPercentAndTotal = function(a, d) {
            var c = null,
                b = null,
                e = c = null;
            if (0 <= a.type.indexOf("stacked")) b = 0, c = d.x.getTime ? d.x.getTime() : d.x,
                c in a.plotUnit.yTotals && (b = a.plotUnit.yTotals[c], c = a.plotUnit.yAbsTotals[c], e = isNaN(d.y) ? 0 : 0 === c ? 0 : 100 * (d.y / c));
        ...
        m.prototype.replaceKeywordsWithValue = function(a, d, c, b, e) {
            ...
            if ((0 <= c.type.indexOf("stacked") || "pie" === c.type || "doughnut" === c.type ||
                ...
                do {
                    ...
                    a = a.replace("#total", ea(h, c.yValueFormatString ?
            ...
            return a.replace(/\{.*?\}|"[^"]*"|'[^']*'/g, function(a) {
                ...
                g = null;
                if ("color" === a) return "waterfall" === c.type ? d.color ? d.color : 0 < d.y ? c.risingColor :
                    c.fallingColor : "error" === c.type ? c.color ? c.color : c._colorSet[k % c._colorSet.length] : d.color ? d.color : c.color ? c.color : c._colorSet[b % c._colorSet.length];
                ...
                else return "y" === a ? ea(g, d.yValueFormatString ? d.yValueFormatString : c.yValueFormatString ? c.yValueFormatString : c.yValueFormatString = "#,##0.########", f._cultureInfo) : "z" === a ? ea(g, d.zValueFormatString ? d.zValueFormatString : c.zValueFormatString ? c.zValueFormatString : c.zValueFormatString = "#,##0.########",
                    f._cultureInfo) : g
            })
        };
        na(E, V);
        E.prototype.setLayout = function() {
            ...
            var m = [],
                k = [];
            if ("top" === this.verticalAlign || "bottom" === this.verticalAlign) this.orientation = "horizontal", c = this.verticalAlign, f = this.maxWidth = null !== this.maxWidth ?
                this.maxWidth : d.width, l = this.maxHeight = null !== this.maxHeight ? this.maxHeight : 0.5 * d.height;
                ...
                if (p.dataPoints &&
                    ...
                    if ("pie" !== p.type && "doughnut" !== p.type && "funnel" !== p.type && "pyramid" !== p.type) {
                        var q = p.legendMarkerType = p.legendMarkerType ? p.legendMarkerType : "line" !== p.type && "stepLine" !== p.type && "spline" !== p.type && "scatter" !== p.type && "bubble" !== p.type || !p.markerType ? "error" === p.type && p._linkedSeries ? p._linkedSeries.legendMarkerType ? p._linkedSeries.legendMarkerType : H.getDefaultLegendMarker(p._linkedSeries.type) : H.getDefaultLegendMarker(p.type) : p.markerType,
                            g = p.legendText ? p.legendText : this.itemTextFormatter ?
                            ...
                            t = p.legendMarkerBorderThickness ? p.legendMarkerBorderThickness : p.markerBorderThickness ?
                        ...
                        for (var x = 0; x < p.dataPoints.length; x++) {
                            var y = p.dataPoints[x],
                                ...
                                w = y.legendMarkerBorderColor ? y.legendMarkerBorderColor : p.legendMarkerBorderColor ? p.legendMarkerBorderColor : y.markerBorderColor ? y.markerBorderColor :
                                p.markerBorderColor,
                                t = y.legendMarkerBorderThickness ? y.legendMarkerBorderThickness : p.legendMarkerBorderThickness ? p.legendMarkerBorderThickness : y.markerBorderThickness || p.markerBorderThickness ? Math.max(1, Math.round(0.2 * v)) : 0,
            ...
            if (0 < m.length) {
                p = null;
                r = g = y = x = 0;
                y = null !== this.itemWidth ? null !== this.itemMaxWidth ? Math.min(this.itemWidth, this.itemMaxWidth, f) : this.itemMaxWidth = Math.min(this.itemWidth, f) : null !== this.itemMaxWidth ? Math.min(this.itemMaxWidth, f) : this.itemMaxWidth = f;
        ...
        D.setLayout = function(a, d, c, b, e, f) {
            ...
            for (var w = v = 0, t = 0, x = 0, y = 0, B = 0, C = 0, z, D, E = h = 0, H, J, L, r = H = J = L = !1, g = 0; g < q.length; g++) q[g] && q[g].title && (q[g]._titleTextBlock = new ia(q[g].ctx, {
                text: q[g].title,
                horizontalAlign: "center",
            ...
            if ("normal" === e) {
                for (var x = [], y = [], B = [], C = [], M = [], N = [], Q = [], R = []; 4 >
                    ...
                    var G = 0,
                        ...
                        $ = 0;
                    if (c && 0 < c.length)
                        for (B = [], g = O = 0; g < c.length; g++) B.push(Math.ceil(c[g] ? c[g].createLabelsAndCalculateWidth() : 0)), O += B[g], K += c[g] && !n.isNavigator ? c[g].margin : 0;
                    ...
                    if (c && 0 < c.length)
                        for (g = 0; g < c.length; g++) K = n.isNavigator ? 0 : 10, c[g] && (l = Math.round(a[0] ? a[0].lineCoordinates.x1 : d[0].lineCoordinates.x1), K = c[g]._labels && 0 < c[g]._labels.length ? c[g]._labels[c[g]._labels.length - 1].textBlock.height / 2 : p, h = Math.round(f.y1 + W + X < Math.max(K, p) ? Math.max(K, p) : f.y1 + W + X), m = Math.round(a[0] ? a[0].lineCoordinates.x1 : d[0].lineCoordinates.x1), K = 0 < a.length ? 0 : c[g]._labels && 0 < c[g]._labels.length ? c[g]._labels[0].textBlock.height /
                            2 : p, k = Math.round(f.y2 - U - e - K), c[g].lineCoordinates = {
                                ...
                                c[g].lineCoordinates.height ? c[g].titleMaxWidth : c[g].lineCoordinates.height), V += B[g] + c[g].margin);
                    if (b && 0 < b.length)
                ...
                for (N = []; 4 > v;) {
                    ...
                    if (a && 0 < a.length)
                        for (E = [], g = Y = 0; g < a.length; g++) E.push(Math.ceil(a[g] ? a[g].createLabelsAndCalculateWidth() : 0)), Y += E[g], e += a[g] && !n.isNavigator ? a[g].margin : 0;
                    ...
                    N.push(w);
                    if (c && 0 < c.length)
                        for (g = 0; g < c.length; g++) c[g].lineCoordinates = {}, l = Math.round(f.x1 + Y + e), m = Math.round(f.x2 - U - X > n.width - 10 ? n.width - 10 : f.x2 - U - X), c[g].labelAutoFit && !s(x) && (0 < !a.length && (l = 0 > c[g].labelAngle ? Math.max(l, x) : 0 === c[g].labelAngle ? Math.max(l, x / 2) : l), 0 < !d.length && (m = 0 < c[g].labelAngle ? m - y / 2 : 0 === c[g].labelAngle ? m - y / 2 : m)), c[g].lineCoordinates.x1 = l, c[g].lineCoordinates.x2 = m, c[g].lineCoordinates.width = Math.abs(m - l), c[g].title && (c[g]._titleTextBlock.maxWidth = 0 < c[g].titleMaxWidth && c[g].titleMaxWidth <
                            c[g].lineCoordinates.width ? c[g].titleMaxWidth : c[g].lineCoordinates.width);
                    if (b && 0 < b.length)
                        for (g = 0; g < b.length; g++) b[g].lineCoordinates = {}, l = Math.round(f.x1 + Y + e), m = Math.round(f.x2 - U - X > b[g].chart.width - 10 ? b[g].chart.width - 10 : f.x2 - U - X), b[g] && b[g].labelAutoFit && !s(B) && (0 < !a.length && (l = 0 < b[g].labelAngle ? Math.max(l, B) : 0 === b[g].labelAngle ? Math.max(l, B / 2) : l), 0 < !d.length && (m -= C / 2)), b[g].lineCoordinates.x1 = l, b[g].lineCoordinates.x2 = m, b[g].lineCoordinates.width = Math.abs(m - l), b[g].title && (b[g]._titleTextBlock.maxWidth =
                    ...
                    D.push(p);
                    if (b && 0 < b.length)
                        for (z = [], g = T = 0; g < b.length; g++) z.push(Math.ceil(b[g] ? b[g].createLabelsAndCalculateHeight() : 0)), T += z[g], Z += b[g].margin;
            ...
            if (this.scaleBreaks)
                for (l =
                    ...
                    if ((!s(this.sessionVariables.newViewportMinimum) && this.sessionVariables.newViewportMinimum >= this.scaleBreaks._appliedBreaks[l].startValue || !s(this.options.minimum) && this.options.minimum >= this.scaleBreaks._appliedBreaks[l].startValue || !s(this.options.viewportMinimum) && this.viewportMinimum >= this.scaleBreaks._appliedBreaks[l].startValue) && (!s(this.sessionVariables.newViewportMaximum) && this.sessionVariables.newViewportMaximum <= this.scaleBreaks._appliedBreaks[l].endValue ||
                            !s(this.options.maximum) && this.options.maximum <= this.scaleBreaks._appliedBreaks[l].endValue || !s(this.options.viewportMaximum) && this.viewportMaximum <= this.scaleBreaks._appliedBreaks[l].endValue)) {
            ...
            if (0 !== this.spacing || 0 !== this.options.lineThickness && ("undefined" !== typeof this.options.lineThickness || 0 !== this.parent.lineThickness)) {
                ...
                if ("bottom" === this.scaleBreaks.parent._position || "top" === this.scaleBreaks.parent._position)
                    ...
                    if (e = 1 === p % 2 ? (e.y << 0) + 0.5 : e.y << 0, h = 1 === p % 2 ? (b.y << 0) + 0.5 : b.y << 0, "left" === this.scaleBreaks.parent._position ? (b = this.chart.plotArea.x1, l = this.chart.plotArea.x2 + p / 2 + 0.5 << 0) : (b = this.chart.plotArea.x2,
                            l = this.chart.plotArea.x1 - p / 2 + 0.5 << 0, a *= -1), this.bounds = {
                            x1: b,
                            y1: e - p / 2,
                            x2: l,
                            y2: h + p / 2
        ...
        M.prototype.render = function() {
            ...
            if (0 < d) {
                ...
                if ("bottom" === this.parent._position || "top" === this.parent._position) e = f = 1 ===
                    this.ctx.lineWidth % 2 ? (a.x << 0) + 0.5 : a.x << 0, l = this.chart.plotArea.y1, h = this.chart.plotArea.y2, this.bounds = {
                        x1: e - d / 2,
                        y1: l,
                        x2: f + d / 2,
                        y2: h
        ...
        $.prototype.render = function(a, d, c) {
            ...
            if (this.snapToDataPoint) {
                ...
                if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
                    ...
                    for (var w = 0; w < this.parent.dataSeries.length; w++)(v = this.parent.dataSeries[w].getDataPointAtX(r, !0)) && 0 <= v.index && (v.dataSeries = this.parent.dataSeries[w], null !== v.dataPoint.y && v.dataSeries.visible && n.push(v));
                    v = null;
                    ...
                    if ("rangeBar" === n[0].dataSeries.type ||
                        ...
                        for (var v = Math.abs(a - this.parent.convertValueToPixel(n[0].dataPoint.y)), y = t =
                            ...
                            else y += n[r].dataPoint.y, t = Math.abs(a - this.parent.convertValueToPixel(y)), t < v && (v = t, w = r);
                    else if ("stackedBar100" === n[0].dataSeries.type)
                        for (var v = Math.abs(a - this.parent.convertValueToPixel(n[0].dataPoint.y)), B = y = t = 0, r = 0; r < n.length; r++)
                            if (n[r].dataPoint.y && n[r].dataPoint.y.length)
                                for (x = 0; x < n[r].dataPoint.y.length; x++) t =
                                    Math.abs(a - this.parent.convertValueToPixel(n[r].dataPoint.y[x])), t < v && (v = t, w = r);
                            else y += n[r].dataPoint.y, B = n[r].dataPoint.x.getTime ? n[r].dataPoint.x.getTime() : n[r].dataPoint.x, B = 100 * (y / n[r].dataSeries.plotUnit.dataPointYSums[B]), t = Math.abs(a - this.parent.convertValueToPixel(B)), t < v && (v = t, w = r);
                    else
                        for (v = Math.abs(a - this.parent.convertValueToPixel(n[0].dataPoint.y)), r = w = t = 0; r < n.length; r++)
                            if (n[r].dataPoint.y && n[r].dataPoint.y.length)
                    ...
                    if ("bottom" === this.parent._position || "top" === this.parent._position) {
                        ...
                        if ("rangeBar" === this.parent.dataSeries[w].type || "error" === this.parent.dataSeries[w].type) {
                            ...
                            for (r = w; 0 <= r; r--) y += n[r].dataPoint.y, t = Math.abs(a -
                                this.parent.convertValueToPixel(y)), t < v && (v = t, b = r);
                            ...
                            v = Math.abs(a - this.parent.convertValueToPixel(n[0].dataPoint.y));
                            B = y = t = 0;
                            for (r = w; 0 <= r; r--) y += n[r].dataPoint.y, B = n[r].dataPoint.x.getTime ? n[r].dataPoint.x.getTime() : n[r].dataPoint.x, B = 100 * (y / n[r].dataSeries.plotUnit.dataPointYSums[B]), t = Math.abs(a - this.parent.convertValueToPixel(B)), t < v && (v = t, b = r);
                        ...
                        if (this.parent.labels)
                            ...
                            }) : s(this.options.label) ? za(c ? c : x.dataPoint.x, this.valueFormatString, this.chart._cultureInfo) :
                            this.label : "number" === this.parent.valueType && (k.text = this.labelFormatter ? this.labelFormatter({
                                chart: this.chart,
                                axis: this.parent.options,
                                crosshair: this.options,
                                value: c ? c : x.dataPoint.x
                    ...
                    for (w = 0; w < this.parent.dataSeries.length; w++)(v = this.parent.dataSeries[w].getDataPointAtX(r, !0)) && 0 <= v.index && (v.dataSeries = this.parent.dataSeries[w], null !== v.dataPoint.y &&
                        v.dataSeries.visible && n.push(v));
                    if (0 === n.length) return;
                    n.sort(function(a, b) {
                        return a.distance - b.distance
                    });
                    ...
                    for (w = 0; w < this.parent.dataSeries.length; w++)(v = this.parent.dataSeries[w].getDataPointAtX(r,
                        !0)) && 0 <= v.index && (v.dataSeries = this.parent.dataSeries[w], null !== v.dataPoint.y && v.dataSeries.visible && n.push(v));
                    if (0 === n.length) return;
                    n.sort(function(a, b) {
                        return a.distance - b.distance
                    });
                    ...
                    if ("rangeColumn" === n[0].dataSeries.type || "rangeArea" === n[0].dataSeries.type || "error" === n[0].dataSeries.type || "rangeSplineArea" === n[0].dataSeries.type || "candlestick" === n[0].dataSeries.type || "ohlc" === n[0].dataSeries.type || "boxAndWhisker" === n[0].dataSeries.type)
                        for (v = Math.abs(d - this.parent.convertValueToPixel(n[0].dataPoint.y[0])),
                            r = t = 0; r < n.length; r++)
                            if (n[r].dataPoint.y && n[r].dataPoint.y.length)
                        ...
                        for (v = Math.abs(d - this.parent.convertValueToPixel(n[0].dataPoint.y)), r = y = t = 0; r < n.length; r++)
                            if (n[r].dataPoint.y && n[r].dataPoint.y.length)
                                for (x = 0; x <
                                    n[r].dataPoint.y.length; x++) t = Math.abs(d - this.parent.convertValueToPixel(n[r].dataPoint.y[x])), t < v && (v = t, w = r);
                            else y += n[r].dataPoint.y, t = Math.abs(d - this.parent.convertValueToPixel(y)), t < v && (v = t, w = r);
                    else if ("stackedColumn100" === n[0].dataSeries.type || "stackedArea100" === n[0].dataSeries.type)
                        for (v = Math.abs(d - this.parent.convertValueToPixel(n[0].dataPoint.y)), r = B = y = t = 0; r < n.length; r++)
                            if (n[r].dataPoint.y && n[r].dataPoint.y.length)
                                for (x = 0; x < n[r].dataPoint.y.length; x++) t = Math.abs(d - this.parent.convertValueToPixel(n[r].dataPoint.y[x])),
                                    t < v && (v = t, w = r);
                            else y += n[r].dataPoint.y, B = n[r].dataPoint.x.getTime ? n[r].dataPoint.x.getTime() : n[r].dataPoint.x, B = 100 * (y / n[r].dataSeries.plotUnit.dataPointYSums[B]), t = Math.abs(d - this.parent.convertValueToPixel(B)), t < v && (v = t, w = r);
                    else
                        for (v = Math.abs(d - this.parent.convertValueToPixel(n[0].dataPoint.y)), r = t = 0; r < n.length; r++)
                            if (n[r].dataPoint.y && n[r].dataPoint.y.length)
                                for (x = 0; x < n[r].dataPoint.y.length; x++) t = Math.abs(d - this.parent.convertValueToPixel(n[r].dataPoint.y[x])), t < v && (v = t, w = r);
                            else t = Math.abs(d -
                                this.parent.convertValueToPixel(n[r].dataPoint.y)), t < v && (v = t, w = r);
                    x = n[w];
                    b = 0;
                    if ("rangeColumn" === this.parent.dataSeries[w].type || "rangeArea" === this.parent.dataSeries[w].type || "error" === this.parent.dataSeries[w].type || "rangeSplineArea" === this.parent.dataSeries[w].type || "candlestick" === this.parent.dataSeries[w].type || "ohlc" === this.parent.dataSeries[w].type || "boxAndWhisker" === this.parent.dataSeries[w].type) {
                        ...
                        for (r = t = 0; r < x.dataPoint.y.length; r++) t =
                            Math.abs(d - this.parent.convertValueToPixel(x.dataPoint.y[r])), t < v && (v = t, b = r);
                        ...
                        y = t = 0;
                        for (r = w; 0 <= r; r--) y += n[r].dataPoint.y, t = Math.abs(d - this.parent.convertValueToPixel(y)), t < v && (v = t, b = r);
                        ...
                        v = Math.abs(d - this.parent.convertValueToPixel(n[0].dataPoint.y));
                        y = t = 0;
                        for (r = w; 0 <= r; r--) y += n[r].dataPoint.y, B = n[r].dataPoint.x.getTime ? n[r].dataPoint.x.getTime() : n[r].dataPoint.x, B = 100 * (y / n[r].dataSeries.plotUnit.dataPointYSums[B]), t = Math.abs(d - this.parent.convertValueToPixel(B)), t < v && (v = t, b = r);
                        m =
                        ...
                        k.text = this.labelFormatter ? this.labelFormatter({
                            ...
                            crosshair: this.options,
                            value: c ? c : B
                        }) : s(this.options.label) ? ea(c ? c : B, this.valueFormatString, this.chart._cultureInfo) : this.label;
                        this.value = B
                ...
                if ("xySwapped" === this.chart.plotInfo.axisPlacement)
                    if ("left" === this.parent._position || "right" === this.parent._position) {
                        ...
                        if (this.parent.labels)
                            ...
                            if ("axisX" === this.parent.type)
                                for (r = this.parent.convertPixelToValue({
                                        y: d
                                    }), v = null, w = 0; w < this.parent.dataSeries.length; w++)(v = this.parent.dataSeries[w].getDataPointAtX(r, !0)) && 0 <= v.index &&
                                    (k.text = this.labelFormatter ? this.labelFormatter({
                                        chart: this.chart,
                                        axis: this.parent.options,
                                        crosshair: this.options,
                            ...
                            }) : s(this.options.label) ? za(c ? c : this.parent.convertPixelToValue(d), this.valueFormatString, this.chart._cultureInfo) :
                            this.label : "number" === this.parent.valueType && (k.text = this.labelFormatter ? this.labelFormatter({
                                chart: this.chart,
                                axis: this.parent.options,
                                crosshair: this.options,
                        ...
                        if ("bottom" === this.parent._position || "top" === this.parent._position) k.text = this.labelFormatter ? this.labelFormatter({
                            ...
                            crosshair: this.options,
                            value: c ? c : this.parent.convertPixelToValue(a)
                        }) : s(this.options.label) ? ea(c ? c : this.parent.convertPixelToValue(a),
                    ...
                    if (this.parent.labels)
                        ...
                        this.parent.valueType ? k.text = this.labelFormatter ? this.labelFormatter({
                            chart: this.chart,
                            axis: this.parent.options,
                            crosshair: this.options,
                            value: c ? c : this.parent.convertPixelToValue(a)
                    ...
                    this.parent._position) k.text = this.labelFormatter ? this.labelFormatter({
                    chart: this.chart,
                    axis: this.parent.options,
                    crosshair: this.options,
                    value: c ? c : this.parent.convertPixelToValue(d)
                }) : s(this.options.label) ? ea(c ? c : this.parent.convertPixelToValue(d), this.valueFormatString, this.chart._cultureInfo) : this.label, k.y = d + k.fontSize / 2 - k.measureText().height / 2 + 2, k.y - k.fontSize / 2 < this.chart.bounds.y1 ? k.y = this.chart.bounds.y1 + k.fontSize / 2 + 2 : k.y + k.measureText().height - k.fontSize / 2 > this.chart.bounds.y2 && (k.y = this.chart.bounds.y2 -
                    ...
                    if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
                        ...
                        if (this.chart.axisX)
                            for (var m = 0; m < this.chart.axisX.length; m++) {
                                for (var l =
                                        this.chart.axisX[m].convertPixelToValue({
                                            y: d
