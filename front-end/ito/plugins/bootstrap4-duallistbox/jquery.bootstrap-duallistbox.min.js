...
! function (a, e) {
    ...
    l.prototype = {
        init: function () {
            this.container = a('<div class="bootstrap-duallistbox-container"> <div class="box1">   <label></label>   <span class="info-container">     <span class="info"></span>     <button type="button" class="btn clear1 pull-right btn-xs"></button>   </span>   <input class="filter" type="text">   <div class="btn-group buttons">     <button type="button" class="btn moveall btn-xs">       <i></i>       <i></i>     </button>     <button type="button" class="btn move btn-xs">       <i></i>     </button>   </div>   <select multiple="multiple" style="font-size:12px;"></select> </div> <div class="box2">   <label></label>   <span class="info-container">     <span class="info"></span>     <button type="button" class="btn clear2 pull-right btn-xs"></button>   </span>   <input class="filter" type="text">   <div class="btn-group buttons">     <button type="button" class="btn remove btn-xs">       <i></i>     </button>     <button type="button" class="btn removeall btn-xs">       <i></i>       <i></i>     </button>   </div>   <select multiple="multiple" style="font-size:12px;"></select> </div></div>').insertBefore(this.element), this.elements = {
        ...
        setBootstrap2Compatible: function (e, t) {
            return (this.settings.bootstrap2Compatible = e) ? (this.container.removeClass("row").addClass("row-fluid bs2compatible"), this.container.find(".box1, .box2").removeClass("col-md-6").addClass("span6"), this.container.find(".clear1, .clear2").removeClass("btn-default btn-xs").addClass("btn-mini"), this.container.find("input, select").removeClass("form-control"), this.container.find(".btn").removeClass("btn-default"), this.container.find(".moveall > i, .move > i").removeClass("fa fa-long-arrow-alt-right fa-lg").addClass("icon-arrow-right"), this.container.find(".removeall > i, .remove > i").removeClass("fa fa-long-arrow-alt-left fa-lg").addClass("icon-arrow-left")) : (this.container.removeClass("row-fluid bs2compatible").addClass("row"), this.container.find(".box1, .box2").removeClass("span6").addClass("col-md-6"), this.container.find(".clear1, .clear2").removeClass("btn-mini").addClass("btn-default btn-xs"), this.container.find("input, select").addClass("form-control"), this.container.find(".btn").addClass("btn-default"), this.container.find(".moveall > i, .move > i").removeClass("icon-arrow-right").addClass("fa fa-long-arrow-alt-right fa-lg"), this.container.find(".removeall > i, .remove > i").removeClass("icon-arrow-left").addClass("fa fa-long-arrow-alt-left fa-lg")), t && m(this), this.element
        },
        ...
        var t, i = arguments;
        return n === e || "object" == typeof n ? this.each(function () {
